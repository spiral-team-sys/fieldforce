...
const handlePermissionResult = async (
  ...
  switch (result) {
    case RESULTS.UNAVAILABLE:
      toastError(
        `Quyền truy cập ${permissionName}`,
        'Quyền không có sẵn trên thiết bị này. Vui lòng kiểm tra lại trong cài đặt của thiết bị',
      );
      return false;
    case RESULTS.DENIED:
    ...
    case RESULTS.BLOCKED:
      ...
      optionConfirm(
        `Quyền bị chặn ${permissionName}`,
        'Vui lòng kiểm tra lại các quyền sử dụng ứng dụng trong cài đặt',
        options,
      );
      return false;
    default:
...
export const MICROPHONE_PERMISSION =
  Platform.OS === 'ios'
    ? PERMISSIONS.IOS.MICROPHONE
    : PERMISSIONS.ANDROID.RECORD_AUDIO;
export const STORAGE_PERMISSION =
  Platform.OS === 'ios' ? null : PERMISSIONS.ANDROID.WRITE_EXTERNAL_STORAGE;
//
