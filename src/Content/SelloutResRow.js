    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Hôm nay, không bán được sản phẩm nào ({item.productName})
          </Text>
        </View>
      </GmailStyleSwipeableRow>
    );
        ...
        >
          <Fragment>
            <TouchableOpacity
              style={{ flexGrow: 0.9 }}
              onPress={() =>
                item.productCode !== 'NOSELL' &&
                item.upload == 0 &&
                (canEdit ? ShowDetail(item) : onBlockedAction?.())
              }
            >
              <View
                style={{
            ...
            <View
              style={{
                flexGrow: 0.1,
                backgroundColor:
                  item.upload === 0 ? appcolor.danger : appcolor.info,
                alignSelf: 'center',
                width: 44,
                height: 44,
                borderRadius: 64,
