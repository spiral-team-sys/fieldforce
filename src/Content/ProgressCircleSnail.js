...
class ProgressCircleSnail extends PureComponent {
    ...
    render() {
        return (
            <View style={{ display: (this.props.isShowing ? 'flex' : 'none'), height: '70%', width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                <View style={{ marginBottom: 8, alignSelf: 'center', alignContent: 'stretch' }}>
                    <Progress.CircleSnail color={[this.props.appcolor.black]} thickness={3} />
                </View>
