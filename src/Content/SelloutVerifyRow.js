      ...
      <View style={{ padding: 15 }}>
        ...
        <View>
          {item.custName !== undefined && item.custName !== 'undefined' && (
            <Text style={{ ...styles.title, color: appcolor.dark }}>
              {'Khách hàng: ' + item.custName}
            </Text>
          )}
          ...
          {typeof item.productName !== 'undefined' &&
            item.productName !== null && (
              <Text style={{ ...styles.subTitle, color: appcolor.dark }}>
          ...
          {item.custAddress !== undefined &&
            item.custAddress !== null &&
            item.custAddress !== 'undefined' && (
              <Text style={{ ...styles.subTitle, color: appcolor.dark }}>
                {item.custAddress}
              </Text>
          ...
          {item.optional !== undefined &&
            ...
            item.optional !== 'undefined' && (
              <Text
                style={{
                  ...{ ...styles.subTitle, color: appcolor.dark },
                  color:
                    item.imeiStatus === 2
                      ? 'green'
                      : item.imeiStatus === 1
          ...
          {item.tribeReason !== undefined &&
            item.tribeReason !== null &&
            item.tribeReason !== 'undefined' && (
              <Text
                style={{
                  ...{ ...styles.subTitle, color: appcolor.dark },
          ...
          {item.imeiVerify !== undefined &&
            item.imeiVerify !== null &&
            item.imeiVerify !== 'undefined' && (
              <Text
                style={{
                  ...{ ...styles.subTitle, color: appcolor.dark },
