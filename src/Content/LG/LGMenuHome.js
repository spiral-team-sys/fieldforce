...
export const LGMenuHome = ({ navigation, menus }) => {
    ...
    const styles = StyleSheet.create({
        ...
        itemMain: {
            width: deviceWidth / 3.3, backgroundColor: appcolor.light, margin: 8, marginTop: 0, borderWidth: 1, padding: 8, borderRadius: 8, borderColor: appcolor.surface,
            shadowColor: appcolor.grey, shadowOffset: { width: 1, height: 0 }, shadowRadius: 8, shadowOpacity: 0.3, elevation: 3
        },
        ...
        titleName: { fontSize: 13, fontWeight: '500', color: appcolor.dark, width: '100%', textAlign: 'center' }
    })
