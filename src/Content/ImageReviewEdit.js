...
export const ImageReviewEdit = gestureHandlerRootHOC(
  ({ itemPhoto, onClose, loadData }) => {
      ...
      >
        <View style={{ width: '100%', height: '100%' }}>
          <DrawWithOptions
            ...
            image={{
              uri:
                itemPhoto.photoPath !== null &&
                (itemPhoto.photoPath.indexOf('file://') > -1 ||
                itemPhoto.photoPath.indexOf('https://') > -1
                  ? itemPhoto.photoPath
