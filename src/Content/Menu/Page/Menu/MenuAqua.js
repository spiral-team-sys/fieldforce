...
const MenuAqua = ({ item, index = 0, onPress }) => {
    ...
    const styles = StyleSheet.create({
        ...
        itemContent: { width: '100%', paddingVertical: 10, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center' },
        iconCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: appcolor.primary, justifyContent: 'center', alignItems: 'center' },
        titleText: { flex: 1, marginStart: 12, fontSize: 15, fontWeight: fontWeightBold, color: appcolor.dark },
