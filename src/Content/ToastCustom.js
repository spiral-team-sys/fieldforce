          ...
          <Animated.View
            style={[
              this.state.animationStyle,
              {
                ...styles.animatedView,
                backgroundColor:
                  this.state.typeshow !== undefined
                    ? this.getColorCustom(this.state.typeshow)
                    : this.getColorByType(),
              },
          ...
          >
            ...
            >
              ...
              >
                <View style={{ width: '4%' }}>
                  <Image
                    containerStyle={{ height: 20, width: 20, borderRadius: 5 }}
                    source={ICON_NOTIFY}
                  />
                </View>
                <Text
                ...
                <Text
                  style={{ width: '50%', textAlign: 'right', fontSize: 13 }}
                >
                  Bây giờ
                </Text>
              </View>
              ...
              <View style={{ height: 65, paddingRight: 5, top: 10 }}>
                <Text
                  numberOfLines={1}
                  style={[styles.titleStyle, this.props.textStyle]}
                >
                  {this.state.title}
                </Text>
                <Text></Text>
