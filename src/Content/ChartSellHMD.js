        ...
        <View style={{ width: '100%' }}>
          <View
            style={{
              ...
              padding: 3,
              alignItems: 'center',
              backgroundColor: index === 0 && appcolor.primary,
            }}
          >
            {index === 0 &&
              lstKey.map(
    ...
    return (
      <View
        ...
        style={{
          ...
          width:
            dataGroup.length > 1
              ? Dimensions.get('window').width / dataGroup.length - 15
