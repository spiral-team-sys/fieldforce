    ...
    return (
      <View style={{ width: '100%', height: '100%' }}>
        <LottieView
          autoPlay
          style={{ height: '100%' }}
          source={require('../Themes/lotties/error_page.json')}
        />
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: 15, color: appcolor.dark, width: '80%' }}>
            {pageName}
          </Text>
          <TouchableOpacity
          ...
          <View style={{ flex: 1 }}>
            {httpError === 200 ? (
              <WebView
                ...
                injectedJavaScript={
                  Platform.OS === 'ios' ? INJECTEDJAVASCRIPT : null
                }
