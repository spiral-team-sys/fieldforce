...
class MessageForm extends PureComponent {
          ...
          transform: [
            {
              translateY: this.slideYValue.interpolate({
                inputRange: [0, 0.3, 1],
                outputRange:
                  this.props.position == 'bottom' ? [70, -5, 0] : [-70, 5, 0],
              }),
            },
          ],
        },
  ...
  styles = StyleSheet.create({
    container: {
      top: Platform.OS === 'android' ? StatusBar.currentHeight + 30 : 30,
      zIndex: 100,
      elevation: 100,
      position: 'absolute',
      left: 0,
          ...
          <Animated.View
            style={[
              this.state.animationStyle,
              {
                ...
                backgroundColor: this.getColorByType(this.props.type),
              },
              this.props.messageStyle,
              { height: this.props.messageHeight },
            ]}
          >
            <TouchableOpacity
              onPress={() => {
            ...
            >
              ...
              <View style={{ marginStart: 5, top: 2 }}>
                <Text
                  numberOfLines={1}
                  style={[this.styles.titleStyle, this.props.textStyle]}
                >
                  {this.state.title || ''}
                </Text>
                <Text
                  numberOfLines={2}
                  style={[this.styles.textStyle, this.props.textStyle]}
                >
                  {this.state.message || ''}
                </Text>
              </View>
