  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      >
        ...
        >{`Vui lòng di chuyển thiết bị qua lại trong phạm vi vài mét để hệ thống xác định đúng vị trí hiện tại của bạn`}</Text>
        <AnimatedLottieView
          autoPlay
          source={require('../Themes/lotties/movephone.json')}
        />
      </View>
    </SafeAreaView>
  );
