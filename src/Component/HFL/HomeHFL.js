...
import { View, TouchableOpacity, Text, ScrollView, Linking, Modal, Platform, SafeAreaView, LogBox, RefreshControl, StyleSheet, } from 'react-native';
import { defaultSetting, GetEmployeeInfo, MessageSetting, ToastError, ToastSuccess } from '../../Core/Helper';
                        ...
                        (userinfo.employeeId > 0 ?
                            <SafeAreaView style={{ backgroundColor: appcolor.light, flex: 1 }}>
                                ...
                                <View style={{ flexDirection: 'row', marginLeft: 12, minHeight: 42, marginTop: Platform.OS == 'android' ? 40 : 0 }}>
                                    <View style={{ width: 50, justifyContent: 'center', }}>
                                        <TouchableOpacity onPress={() => this.props.navigation.openDrawer()}>
                                            <Icon name="align-right" color={appcolor.dark} type='feather' size={scaleSize(30)} />
                                        </TouchableOpacity>
                                    </View>
                                        ...
                                        <View style={{ width: 50, justifyContent: 'center', marginRight: 12, justifyContent: 'flex-end' }}>
                                            <TouchableOpacity onPress={() => this.props.navigation.navigate("Notification")}>
                                                <Avatar
                                                    size={42}
                                                    rounded
                                                    icon={{ name: 'bell', type: 'feather', color: appcolor.dark }} />
                                ...
                                <ScrollView
                                    ...
                                    />}>
                                    <View style={{
                                        height: 250, backgroundColor: appcolor.light, borderBottomLeftRadius: 50,
                                        borderBottomRightRadius: 50
                                    }}>
                                        <QuickViewHFL navigation={this.props.navigation} />
                                    </View>

                                    <Text style={{ marginLeft: 20, padding: 6, opacity: 0.5, fontSize: scaleSize(12), fontWeight: '700', color: appcolor.dark }}>Chức năng</Text>
                                    {!this.state.refreshing && <MenuHFL navigation={this.props.navigation} menus={this.state.menus} />}
                                </ScrollView>
                                {/* <ScrollView
                                    showsVerticalScrollIndicator={false}
