...
import { View, Text, Platform, TouchableOpacity, SafeAreaView, StyleSheet, } from "react-native";
...
const LoginDaikin = ({ onLoginCallBack }) => {
    ...
    const styles = StyleSheet.create({
        mainContainer: { width: '100%', height: deviceHeight, backgroundColor: appcolor.light, padding: 24 },
        ...
        titleLogin: { width: '100%', padding: 16, fontSize: scaleSize(22), textAlign: 'center', fontWeight: '700', color: appcolor.dark },
        titleForgot: { fontSize: scaleSize(14), textDecorationLine: 'underline', color: appcolor.dark, fontStyle: 'italic', textAlign: 'center', position: 'absolute', right: 16 },
            ...
            {requestPass ?
                ...
                <View style={styles.mainContainer}>
                    <View style={{ width: '100%', height: '20%', marginTop: 12 }}>
                        <LottieView autoPlay style={{ height: '100%' }} source={require('../../Themes/lotties/daikin_welcome.json')} />
                    </View>
                    ...
                    <View style={styles.mainInput}>
                        <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center' }}>
                            <Input
                                ...
                                leftIcon={<Icon name='person-outline' type='ionicon' color={appcolor.primary} size={23} style={{ padding: 8 }} />}
                        ...
                        <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center' }}>
                            <Input
                                leftIcon={<Icon name='lock-closed-outline' type='ionicon' color={appcolor.primary} size={23} style={{ padding: 8 }} />}
                                style={{ fontSize: 15, color: appcolor.dark }}
                                ref={_refPass}
                                returnKeyType='done'
                        ...
                        <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center' }}>
                            <Input
                                ...
                                leftIcon={<Icon name='phone-portrait' type='ionicon' color={appcolor.primary} size={23} style={{ padding: 8 }} />}
                                style={{ fontSize: 15, color: appcolor.dark }}
                                placeholderTextColor='#c2c2c2' disabled={true}
                                rightIcon={
                                    <TouchableOpacity onPress={setCopy}>
                                        {<Icon name='copy' type='ionicon' color={appcolor.primary} size={23} style={{ padding: 8 }} />}
                                    </TouchableOpacity>
                                }
                            />
                        </View>
