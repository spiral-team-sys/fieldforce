...
export const ItemResultAqua = ({
  ...
  const supportLunch = `Ăn uống ${item.supportLunch > 0 ? formatNumber(item.supportLunch || 0, ',') : 0
    } VNĐ`;
          ...
          >
            ...
            {element.distance !== null && element.distance > 0 && (
              ...
              >
                ...
                >
                  Khoảng cách ~
                  {Math.round(element.distance / 1000) +
                    (element.numberStore || 0) * (quotaData.kmDefault || 5)}
                  km
                </Text>
              </View>
            )}
          ...
          {element.addressPoint !== null && element.addressPoint !== '' && (
            <View style={{ width: '100%', borderRadius: 4 }}>
              ...
              >
                ...
                >
                  Số lượng cửa hàng : {element.numberStore || 0}
                </Text>
              </View>
