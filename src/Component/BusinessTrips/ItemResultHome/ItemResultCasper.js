...
export const ItemResultCasper = ({ item, index, handlerDeleteTrip, handlerConfirmTrip, handlerEditTrips, styles }) => {
	...
	return (
		<View key={`int_${index}`} style={{ width: '100%', paddingStart: 5, paddingEnd: 5, alignSelf: 'center' }}>
			<View style={styles.itemTrips}>
				...
				{typeKM !== null && <ItemView styleView={styles.contentView} value={typeKM} iconName='road' />}
				<ItemView styleView={styles.contentView} value={supportKM} iconName='road' />
				<ItemView styleView={styles.contentView} value={supportVehicalOther} iconName='road' />
				{typePeople !== null && <ItemView styleView={styles.contentView} value={typePeople} iconName='hotel' />}
				<ItemView styleView={styles.contentView} value={supportNight} iconName='hotel' />
				<ItemView styleView={styles.contentView} value={supportLunchAndDinner} iconName='utensils' />
			...
			<View style={{ flexDirection: 'row', alignSelf: 'flex-end', paddingEnd: 8 }}>
				{item.isConfirm == 1 &&
					<ActionPress
						title='Xác nhận'
