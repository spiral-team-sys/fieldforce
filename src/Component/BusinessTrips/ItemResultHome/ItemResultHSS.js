...
export const ItemResultHSS = ({ item, index, handlerDeleteTrip, handlerConfirmTrip, handlerEditTrips, handlerUploadDocument, handlerReConfirmTrip, styles }) => {
    ...
    return (
        <View key={`int_${index}`} style={{ width: '100%', paddingStart: 5, paddingEnd: 5, alignSelf: 'center' }}>
            <View style={styles.itemTrips}>
                ...
                <ItemView styleView={styles.contentView} value={supportOther} iconName='money-bill' />
