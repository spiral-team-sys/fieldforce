...
export const HomeBusinessToshiba = ({ navigation }) => {
  ...
  const handlerEditTrips = async item => {
    ...
    const itemEdit = {
      ...
      typeVehicle: item.typeVehicle || null,
  ...
  const showSelectYearMonth = async () => {
    LayoutAnimation.configureNext(LayoutAnimation.Presets.easeInEaseOut);
    filterInvoice.loadYearMonth = filterInvoice.loadYearMonth ? false : true;
    await setMutate(e => !e);
    // await setFilterInvoice({ ...filterInvoice, loadYearMonth: filterInvoice.loadYearMonth ? false : true })
  };
