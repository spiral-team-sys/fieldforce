...
export const ItemTripPointSharp = ({ item, index, itemTrips, itemPoint, typeVehicle, config, quotaData, handlerDeleteTrip, handlerConfirmTrip, handlerEditTrips, handlerUploadDocument, handlerReConfirmTrip, styles }) => {
