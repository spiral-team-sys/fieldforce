...
import { LayoutAnimation, Platform, ScrollView, StyleSheet, TouchableOpacity, View } from "react-native";
...
export const ViewResultAqua = ({ tripResult, quotaData }) => {
        ...
        <View style={{ width: deviceWidth, padding: 8 }}>
            {tripResult.provinceList !== undefined && tripResult.provinceList.length > 0 &&
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity onPress={() => onPressStage()} style={{
                        marginVertical: 4, marginHorizontal: 8, borderRadius: 8, shadowOpacity: 0.5, elevation: 3,
                        shadowColor: appcolor.dark, shadowOffset: { width: 3, height: 0 },
                        flexDirection: 'row', backgroundColor: appcolor.surface, padding: 4,
                        borderRadius: 8, justifyContent: 'center', alignItems: 'center'
                    }}>
                        <Text key={`NumStage`}
                            style={{ ...styles.titleDateLine, paddingStart: 0, paddingTop: 0, color: appcolor.info, fontSize: 15 }}>
                                ...
                                <View key={'ViewPoint_' + it.id} style={{ borderRadius: 8, backgroundColor: appcolor.surface, padding: 4, marginBottom: 4 }}>
                                    ...
                                    </View>
                                    {
                                        ...
                                        <View style={{ width: '100%', borderRadius: 4 }}>
                                            ...
                                            <View style={{ width: '100%', flexDirection: "row", paddingHorizontal: 4 }}>
                                                <Text style={{ fontWeight: '700', fontSize: 12, color: appcolor.dark }}>Số lượng cửa hàng : {it.numberStore || 0}</Text>
                                            </View>
