...
export const ViewResultHPI = ({ tripResult }) => {
        ...
        <View style={styles.contentView}>
            ...
            <View style={{ width: deviceWidth / 1.4 }}>
                ...
                <View style={styles.costView}>
                    ...
                    <CostItemView title='Ăn có chứng từ' name={tripResult.supportLunch} iconName='utensils' />
                    {/* <CostItemView title='Ăn không chứng từ' name={tripResult.supportDinner} iconName='utensils' /> */}
                    <CostItemView title='Di chuyển bằng máy bay' name={tripResult.supportVehicalOther} iconName='road' />
                    <CostItemView title='Di chuyển' name={tripResult.supportVehical} iconName='car' />
