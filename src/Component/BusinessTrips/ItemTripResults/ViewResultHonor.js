...
export const ViewResultHonor = ({ tripResult }) => {
            ...
            <View style={styles.contentView}>
                ...
                <View style={{ width: deviceWidth / 1.4 }}>
                    ...
                    <View style={styles.costView}>
                        ...
                        <CostItemView title='Hỗ trợ di chuyển' name={tripResult.supportVehicalOther} iconName='car' />
                        {tripResult.kmValue > 0 ?
                            <CostItemView title={`Di chuyển ${(tripResult.kmValue / 1000).toFixed(2)}km -`} name={`${tripResult.supportKM}`} iconName='road' /> :
                            <CostItemView title={`Di chuyển KM`} name={`${tripResult.supportKM}`} iconName='road' />}
                        <CostItemView title='Ăn uuống' name={tripResult.supportLunch} iconName='utensils' />
                        <CostItemView title='Khách sạn' name={tripResult.supportNight} iconName='hotel' />
                        <CostItemView title='Chi phí tiếp khách' name={tripResult.supportWork} iconName='money-bill' />
