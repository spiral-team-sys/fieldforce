...
export const ViewResultBosch = ({ tripResult }) => {
  ...
  const provinceList = Array.isArray(tripResult?.provinceList)
    ? tripResult.provinceList
    : [];
  ...
  return (
    <View style={{ width: deviceWidth, padding: 8 }}>
      ...
      {showStage === true && provinceList.length > 0 && (
        ...
        >
          {provinceList.map(it => {
            const hasAddressPoint =
              it.addressPoint !== null &&
              it.addressPoint !== undefined &&
              it.addressPoint !== '';
            ...
            return (
              ...
              >
                ...
                >
                  <Text
                    style={{
                      width: hasAddressPoint ? '50%' : '100%',
                      fontWeight: '600',
                      fontSize: 12,
                      color: hasAddressPoint ? appcolor.dark : appcolor.tomato,
                      paddingHorizontal: 4,
                    }}
                  >
                    Điểm {it.id + 1}
