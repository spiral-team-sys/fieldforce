...
import { AppNameBuild, aquaApp, bshApp, casperApp, hafeleApp, hisenApp, honorApp, hpiApp, lgApp, mitsuApp, psvApp, sharpApp, tefalApp, toshibaApp, viessmannApp } from "../../Core/URLs"
...
const business_Casper = (data) => {
    ...
    const resultBusiness = {
        ...
        totalSupport: priceKm + priceVehicalValue + priceVehicalOther + priceNightHotel + priceLunch
    }
...
const business_Pana = (data) => {
    ...
    const resultBusiness = {
        ...
        totalSupport: priceKm + priceVehicalValue + priceVehicalOtherValue + priceNightHotel + priceLunch + priceDinner + priceOther
    }
    return resultBusiness
}
const business_Pana_BySup = (data) => {
    ...
    const resultBusiness = {
        ...
        supportVehicalOther: priceVehicalOther,
        daysMove: daysMove,
        totalSupport: priceVehicalValue + priceLunch + priceDinner + priceOther + priceStay + priceVehicalOther + (daysMove * 250000)
    }
    return resultBusiness
}
...
const business_Hisense = (data) => {
    ...
    const resultBusiness = {
        ...
        supportOther: priceOther,
        totalKM: priceVehicalValue,
        totalSupport: priceVehicalValue + priceLunchValue + priceNightHotel + priceOther
    }
    return resultBusiness
}
...
const business_GSV = (data) => {
    ...
    const resultBusiness = {
        ...
        supportNight: priceNightHotel,
        supportVehical: priceVehicalValue,
        totalSupport: priceLunchValue + priceNightHotel + supportKM + priceVehicalValue
    }
    return resultBusiness
}
const business_Aqua = (data) => {
    ...
    const resultBusiness = {
        ...
        totalKM: priceVehicalValue,
        supportVehicalOther: priceVehicalOther,
        totalSupport: priceLunchValue + priceNightHotel + priceVehicalValue + priceVehicalOther
    }
    return resultBusiness
}
...
const business_HPI = (data) => {
    ...
    const resultBusiness = {
        ...
        supportOther: priceOther,
        totalKM: priceVehicalValue,
        totalSupport: priceVehicalValue + priceLunch + priceNightHotel + priceOther + priceVehicalOtherValue
    }
    return resultBusiness
}
const business_Honor = (data) => {
    ...
    const resultBusiness = {
        ...
        totalSupport: priceKm + priceLunch + priceNightHotel + priceVehicalOtherValue + priceOther + priceSupportWork
    }
    return resultBusiness
}
...
export const getBusinesDataSupport = (data, groupType) => {
    switch (AppNameBuild) {
        ...
        case psvApp:
            return groupType == 'SUP' ? business_Pana_BySup(data) : business_Pana(data)
        case viessmannApp:
...
const checkDateOverlap = (newFromDate, newToDate, data) => {
    return data.some(item => !(newToDate <= item.fromDate || newFromDate >= item.toDate));
};
