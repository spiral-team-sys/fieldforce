    ...
    return (
      <>
        ...
        >
          ...
          >
            <SpiralIcon color={appcolor.info} name="content-copy" size={12} />
            <Text
              style={{
                color: appcolor.info,
                fontSize: 12,
          ...
          <Text
            style={{ backgroundColor: appcolor.grey, width: 1, height: '100%' }}
          />
          <TouchableOpacity
            style={{
              flexDirection: 'row',
          ...
          >
            <SpiralIcon color={appcolor.info} name="share" size={16} />
            <Text
              style={{
                color: appcolor.info,
                fontSize: 12,
