...
export const DisplayShareDetails = ({ }) => {
    ...
    const styles = StyleSheet.create({
        ...
        titleGroup1: { fontSize: 15, fontWeight: fontWeightBold, color: appcolor.primary, marginTop: 8 },
        titleGroup2: { fontSize: 13, fontWeight: fontWeightBold, color: appcolor.dark, padding: 8 },
        titleItem: { fontSize: 13, fontWeight: '500', color: appcolor.dark, width: '70%', },
        titleItemValue: { width: '30%', fontSize: 13, fontWeight: '500', color: appcolor.dark, textAlign: 'right' },
        viewItemValue: { width: '100%', flexDirection: 'row', padding: 8, backgroundColor: appcolor.surface, borderRadius: 3, marginTop: 1 }
    })
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <ActionSheet id="detailDashboardPhoto" drawUnderStatusBar={Platform.OS == 'ios'} >
