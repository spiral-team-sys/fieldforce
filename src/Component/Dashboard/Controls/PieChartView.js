...
export const PieChartView = ({ item, handleSelect, listColor, isPercentValues = true }) => {
    ...
    const styles = StyleSheet.create({
        mainContainer: { minHeight: deviceHeight / 3.5, margin: 8, borderWidth: 0.5, borderColor: appcolor.grayLight, borderRadius: 8, backgroundColor: appcolor.light },
        ...
        <View style={styles.mainContainer}>
            {!isLoading &&
                <PieChart
                    ...
                    animation={{
                        durationX: 0, durationY: 2000, easingX: 'EaseInOutBack', easingY: 'EaseOutSine'
                    }}
                    ...
                    holeRadius={45}
                    maxAngle={360}
                    styledCenterText={{ size: 14, color: processColor('#000'), text: `Tổng ${chartSetting.totalValue}` }}
