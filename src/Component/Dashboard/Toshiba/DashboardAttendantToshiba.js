...
import { FlatList, Platform, ScrollView, StatusBar, StyleSheet, TouchableOpacity, View } from "react-native";
...
export const DashboardAttendantToshiba = ({ navigation, typeDashboard, viewHeight }) => {
    ...
    const styles = StyleSheet.create({
        mainContainer: { padding: 12, flexDirection: 'column', justifyContent: 'space-between' },
        titleDashboard: { width: '80%', fontSize: 12, fontWeight: '700', color: appcolor.blacklight },
        ...
        contentItem: { width: '100%', flexDirection: 'row', marginBottom: 8, alignItems: 'center' },
    ...
    if (isLoading) {
        ...
        return (
            <TouchableOpacity onPress={showDetails} style={{ maxHeight: viewHeight - 40 }}  >
