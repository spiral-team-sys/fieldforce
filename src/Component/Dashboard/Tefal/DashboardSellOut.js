                ...
                <View style={{ width: '100%', flexDirection: "row" }}>
                    ...
                    <View style={{ width: '50%', alignItems: 'center', justifyContent: 'center' }}>
                        <View style={{ width: '100%', justifyContent: 'center', marginStart: 24 }}>
                            ...
                            <Text style={{ fontSize: scaleSize(30), fontWeight: '800', color: appcolor.tomato, marginStart: 8 }}>{`${dataSellOut.targetValue || 0}`}</Text>
                            <Text style={{ fontSize: 15, fontWeight: '500', color: appcolor.dark, padding: 5 }}>{`Actual`}</Text>
                            <Text style={{ fontSize: scaleSize(18), fontWeight: '700', color: appcolor.info, marginStart: 8 }}>{`${dataSellOut.l1 || 'Số lượng'}: ${dataSellOut.v1 || 0}`}</Text>
                            <Text style={{ fontSize: scaleSize(18), fontWeight: '700', color: appcolor.info, marginStart: 8 }}>{`${dataSellOut.l2 || 'Thành tiền'}: ${dataSellOut.v2 || 0}`}</Text>
                        </View>
                    </View>
                    {/* Dashboard PieChart */}
