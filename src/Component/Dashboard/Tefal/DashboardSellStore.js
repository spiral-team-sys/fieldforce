...
export const DashBoardSellStore = ({
  navigation,
  typeDashboard,
  viewHeight,
  bgViewItem = null,
  ...
  const onViewDetail = () => {
    navigation.navigate(
      dataDashboard.dashboardMain?.pageName || 'dashboardDetail',
    );
  };
  //
  useEffect(() => {
  ...
  const styles = StyleSheet.create({
    ...
    itemView: {
      width: '100%',
      alignItems: 'center',
      backgroundColor: bgViewItem || appcolor.surface,
      borderRadius: 8,
      overflow: 'hidden',
    },
    valueView: {
      ...
      >
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            >
              {dataDashboard.dashboardMain.title
                ? dataDashboard.dashboardMain?.title
                : ''}
            </Text>
          </View>
        ...
        <View style={{ width: '100%', height: '100%', paddingTop: 8 }}>
          <View style={{ flexGrow: 1 }}>
            ...
            >
              ...
              >
                {dataDashboard.dashboardMain.title1 || 'Tổng cửa hàng'}
              </Text>
              <Text
                style={{
                  fontWeight: '700',
              ...
              >
                {dataDashboard.dashboardMain.totalStore || '0'}
              </Text>
            </View>
            <View style={{ flexDirection: 'row', padding: 16 }}>
              ...
              >
                ...
                >
                  {dataDashboard.dashboardMain.title2 || 'Model Trưng bày'}
                </Text>
                <Text
                  style={{
                    fontWeight: '700',
                    ...
                    paddingHorizontal: 8,
                    textShadowColor: appcolor.dark,
                    textShadowOffset: { width: 0, height: 0.4 },
                    textShadowRadius: 3,
                  }}
                >
                  {dataDashboard.dashboardMain.totalModel || '0'}
                </Text>
              </View>
              <View
                style={{
              ...
              >
                ...
                >
                  {dataDashboard.dashboardMain.title3 || 'Model Chưa bán'}
                </Text>
                <Text
                  style={{
                    fontWeight: '700',
                ...
                >
                  {dataDashboard.dashboardMain.totalModel -
                    dataDashboard.dashboardMain.totalSell || '0'}
                </Text>
              </View>
            </View>
          </View>
