...
export const DashboardAttendant = ({ navigation, typeDashboard, viewHeight }) => {
    ...
    const styles = StyleSheet.create({
        ...
        contentItem: { width: '100%', flexDirection: 'row', marginBottom: 8, alignItems: 'center', padding: 8 },
    ...
    return (
        <TouchableOpacity onPress={showDetails} style={{ padding: 8, maxHeight: viewHeight - 40, height: deviceHeight }}>
