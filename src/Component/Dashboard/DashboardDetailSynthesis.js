...
export const DashboardDetailSynthesis = ({
  title,
  dataSummary,
  dataHeader,
  onClose,
    ...
    return (
      <View style={{}}>
        ...
        >
          <View
            style={{
              width: data.dataHeader?.numColumn > 2 ? '40%' : '60%',
              backgroundColor:
          ...
          {data.dataHeader?.column1 !== null &&
            data.dataHeader?.column1 !== undefined && (
              <View
                style={{
                  width: `${
                    data.dataHeader?.numColumn > 2
                      ? 60
                      : 40 / data.dataHeader?.numColumn
                  }%`,
                  backgroundColor:
                    index % 2 == 0 ? appcolor.homebackground : appcolor.light,
                  justifyContent: 'center',
              ...
              >
                ...
                >
                  {item[data.dataHeader?.itemField1] == 0
                    ? 0
                    : item[data.dataHeader?.itemField1] || '-'}
                </Text>
              </View>
            )}
          {data.dataHeader?.column2 !== null &&
            data.dataHeader?.column2 !== undefined && (
              <View
                style={{
                  width: `${
                    data.dataHeader?.numColumn > 2
              ...
              >
                ...
                >
                  {item[data.dataHeader?.itemField2] == 0
                    ? 0
                    : item[data.dataHeader?.itemField2] || '-'}
                </Text>
              </View>
            )}
          {data.dataHeader?.column3 !== null &&
            data.dataHeader?.column3 !== undefined && (
              <View
                style={{
                  width: `${
                    data.dataHeader?.numColumn > 2
              ...
              >
                ...
                >
                  {item[data.dataHeader?.itemField3] == 0
                    ? 0
                    : item[data.dataHeader?.itemField3] || '-'}
                </Text>
              </View>
            )}
          {data.dataHeader?.column4 !== null &&
            data.dataHeader?.column4 !== undefined && (
              <View
                style={{
                  width: `${
                    data.dataHeader?.numColumn > 2
              ...
              >
                ...
                >
                  {item[data.dataHeader?.itemField4] == 0
                    ? 0
                    : item[data.dataHeader?.itemField4] || '-'}
                </Text>
              </View>
            )}
        </View>
  ...
  const filterDoneProduct = () => {
    if (!isDone) {
      let lstRes = data.dataSummary.filter(
        it =>
          (it[data.dataHeader?.itemField1] !== null &&
            it[data.dataHeader?.itemField1] >= 0) ||
          (it[data.dataHeader?.itemField2] !== null &&
            it[data.dataHeader?.itemField2] >= 0) ||
          (it[data.dataHeader?.itemField3] !== null &&
            it[data.dataHeader?.itemField3] >= 0) ||
          (it[data.dataHeader?.itemField4] !== null &&
            it[data.dataHeader?.itemField4] >= 0),
      );
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            <SpiralIcon name="filter" size={21} color={appcolor.dark} />
          </TouchableOpacity>
        </View>
        <TitleDashboard />
