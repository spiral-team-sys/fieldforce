...
export const LoginToshiba = ({ onLoginCallBack }) => {
    ...
    const handlerLogin = async () => {
        ...
        if (!isNetwork) {
            ToastError("Không có kết nối mạng, vui lòng kiểm tra lại kết nối sau đó thử lại.", "Mạng", "top");
            return
        }
    ...
    const styles = StyleSheet.create({
        mainContainer: { width: '100%', height: '100%', backgroundColor: appcolor.light, padding: 24 },
        ...
        titleLogin: { width: '100%', padding: 16, fontSize: scaleSize(28), fontWeight: '700', color: appcolor.dark, textAlign: 'center' },
        titleForgot: { fontSize: scaleSize(14), color: appcolor.dark, fontWeight: '600', textAlign: 'center', position: 'absolute', right: 16 },
            ...
            {requestPass ?
                ...
                <View style={styles.mainContainer}>
                    <View style={{ width: '100%', height: '20%', marginTop: 32 }}>
                        <LottieView autoPlay style={{ height: '100%' }} source={require('../../../Themes/lotties/welcome_tefal.json')} />
                    </View>
                    ...
                    <View style={styles.mainInput}>
                        ...
                        <Button
                            buttonStyle={{ width: '50%', padding: 12, backgroundColor: appcolor.primary, borderRadius: 10, alignSelf: 'center', marginTop: 16 }}
                    ...
                    <View style={{ width: '100%', flexGrow: 1, alignSelf: 'center', bottom: 8, }}>
