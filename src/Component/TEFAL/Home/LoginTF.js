...
export const LoginTF = ({ onLoginCallBack }) => {
            ...
            {requestPass ?
                ...
                <View style={styles.mainContainer}>
                    <View style={{ width: '100%', height: '20%', marginTop: 32 }}>
                        <LottieView style={{ height: '100%' }} autoPlay source={require('../../../Themes/lotties/welcome_tefal.json')} />
                    </View>
                    ...
                    <View style={{ width: '100%', flexGrow: 1, alignSelf: 'center', position: "absolute", bottom: 8 }}>
