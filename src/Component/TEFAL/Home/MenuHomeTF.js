        ...
        >
          ...
          >
            <View style={{ width: '70%', left: 70 }}>
              <Text
                style={{
                  color: index == 0 ? appcolor.white : appcolor.dark,
                  fontWeight: '700',
                }}
              >
                {item.menuNameVN}
    ...
    <View style={styles.mainContainer}>
      <View style={{ width: deviceWidth }}>
        {data.isShowToday && (
          <View
            style={{
              display: data.currentTab == 1 ? 'flex' : 'none',
              width: '100%',
              height: '100%',
        ...
        <View
          style={{
            display: data.currentTab == 2 ? 'flex' : 'none',
            marginTop: 8,
          }}
        >
          {isLoading && (
            ...
            >
              <View
                style={{
                  borderRadius: 50,
                  borderWidth: 0.6,
                  borderColor: appcolor.switchEnable,
                  backgroundColor:
                    data?.currentTab == 1
                      ? appcolor.switchEnable
                      : appcolor.light,
                  width: 35,
                  height: 35,
                  justifyContent: 'center',
          ...
          >
            <View
              style={{
                borderRadius: 50,
                backgroundColor:
                  data?.currentTab == 2 ? appcolor.info : appcolor.light,
                borderWidth: 0.6,
            ...
            >
              <SpiralIcon
                ...
                type="MaterialIcons"
                size={18}
                color={data?.currentTab == 2 ? appcolor.white : appcolor.info}
              />
            </View>
            <Text
              style={{
