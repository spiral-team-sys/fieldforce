...
import { View, StyleSheet, ScrollView, RefreshControl, Text, AppState, LogBox, Modal } from "react-native";
	...
	return (
		welcome === 1 ?
			...
			userinfo.employeeId > 0 ?
				<View style={{ ...styles.mainContainer, backgroundColor: appcolor.surface }}>
					<HeaderCustom
						isHome={true}
					...
					<View style={{ width: '100%', height: '38%', marginTop: 8 }} >
						...
						<ScrollView
							...
							<SummaryHomeAqua refreshDashboard={refreshing} navigation={navigation} />
						</ScrollView>
					</View>
					<View style={{ width: '100%', height: '100%' }}>
						<View style={{ ...styles.menuView, backgroundColor: appcolor.light }}>
							<View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', backgroundColor: appcolor.primary, padding: 8, borderTopEndRadius: 8, borderTopStartRadius: 8 }}>
