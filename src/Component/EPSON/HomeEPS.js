...
import { _competitorId, MENU_TYPE, TRAINEEKEY, AppNameBuild } from '../../Core/URLs';
                    ...
                    this.state.welcome === 1 ?
                        ...
                        userinfo.employeeId !== undefined ?
                            <View style={{ flex: 1, backgroundColor: appcolor.surface }}>
                                ...
                                />
                                <LoadingView isLoading={this.state.refreshing} title='Đang tải dữ liệu' styles={{ marginTop: 8 }} />
                                <ScrollView
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'column', padding: 7 }}>
                                        ...
                                        <View style={{ flexGrow: 1, backgroundColor: appcolor.light }}>
                                            ...
                                            {this.state.menus.length > 0 && <MainMenu menus={this.state.menus} navigation={this.props.navigation} />}
                                        </View>
                                    </View>
                                </ScrollView>
