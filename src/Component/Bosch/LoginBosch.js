...
class LoginBosch extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            showProgress: false,
                        ...
                        <View style={{ justifyContent: 'space-between', alignItems: 'stretch', flex: 1, backgroundColor: appcolor.primary }}>
                            <View style={{ height: '100%', width: '100%' }}>
                                <View style={{ height: '27%', paddingTop: 40 }}>
                                    <Text style={{ marginLeft: 12, width: '100%', fontWeight: "bold", fontSize: scaleSize(32), color: appcolor.dark }}>Đăng nhập {APPNAME.toLocaleLowerCase()}</Text>
                                    ...
                                    <View style={{
                                        ...
                                        borderTopRightRadius: 50, borderTopLeftRadius: 90,
                                        borderBottomLeftRadius: 120, right: 0, shadowColor: appcolor.dark,
                                        shadowOffset: { width: 10, height: 3 }, elevation: 2, shadowRadius: 10,
                                        width: '53%', height: 232, backgroundColor: appcolor.white
                                    }} />
                                </View>
                                <View style={{
                                    flexGrow: 1, paddingLeft: 22, paddingRight: 22, shadowColor: appcolor.light,
                                    shadowOffset: {
                                        width: 0,
                                        height: 5,
                                    },
                                    shadowOpacity: 0.5, // Điều chỉnh độ trong suốt của bóng đổ
                                    shadowRadius: 5, // Điều chỉnh độ cong của bóng đổ
                                    elevation: 3, // Chỉ định elevation cho Android
                                    borderTopRightRadius: 40, borderTopLeftRadius: 40, backgroundColor: appcolor.light
                                }}>
                                ...
                                <Modal animationType="slide" visible={this.state.showModel || false}>
                                    <WebViewUI onClose={() => this.setState({ showModel: false })}
                                        ...
                                        urlPage={"https://apps.spiral.com.vn/bsh/privacy.html?"} />
                                </Modal>
                            </View>
                            {
...
export default connect(mapStateToProps, mapDispathToProps)(LoginBosch)
