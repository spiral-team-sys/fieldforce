...
export const MenuBosch = ({ navigation, menus }) => {
    ...
    const menuItem = ({ item, index }) => {
        return (
            <TouchableOpacity key={"hk3d2-" + index} style={{
                ...
                backgroundColor: index == 0 ? appcolor.primary : appcolor.surface, marginBottom: 10
                ...
                <View style={{ width: '100%', height: '100%', padding: 12 }}>
                    ...
                    <View style={{ width: '100%', bottom: 10, alignItems: 'flex-end' }}>
                        ...
                        <Text style={{ color: index == 0 ? appcolor.white : appcolor.dark, opacity: 0.3, fontWeight: '600', fontSize: scaleSize(9), }}>{item.menuName}</Text>
                    </View>
                </View>
            </TouchableOpacity>
        )
    ...
    return (
        <View style={{ backgroundColor: appcolor.light, padding: 12, paddingTop: 2 }}>
