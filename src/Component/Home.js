    ...
    userinfo.employeeId !== undefined ?
      <View style={{ backgroundColor: appcolor.light, marginBottom: 20 }}>
        <HeaderCustom
          ...
          iconLeft='bars' countNotify={badge}
          iconRight='bell' rightFunc={() => navigation.navigate("Notification")}
          leftFunc={() => navigation.openDrawer()} />
        <View style={{ padding: 7, top: 0 }}>
          <View style={{
            borderColor: 2, borderRadius: 12, backgroundColor: appcolor.primary,
          }}>
            <Text style={{ padding: 10, color: appcolor.white, fontSize: 17 }}>{'Chức năng'}</Text>
            <View style={{ borderWidth: 0.5, borderColor: appcolor.greylight, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, backgroundColor: appcolor.light, padding: 5 }}>
