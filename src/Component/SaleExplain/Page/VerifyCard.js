...
export const VerifyCard = ({ item, onPress, colorStatus, lableStatus, dataTab = [], styles }) => {
    ...
    const statusColor = displayStatusTab?.isColor || colorStatus[item.confirm] || "#9CA3AF";
    const statusLabel = displayStatusTab?.nameVN || lableStatus[item.confirm] || "Không xác định";
    ...
    return (
        <TouchableOpacity style={styles.card} onPress={onPress}>
            ...
            <Text style={styles.cardSub}>Mã shop: {item.ShopCode || item.shopCode || "--"}</Text>
