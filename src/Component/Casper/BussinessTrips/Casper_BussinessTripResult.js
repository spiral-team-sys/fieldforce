...
export const Casper_BussinessTripResult = ({ bussinessInfo, appcolor, nextView, bottomSheet, presentView, MoneyMove, remaining, PeopleInRoom }) => {
    ...
    const CalculatorBy = () => {
        ...
        if (bussinessShow?.fromDate && bussinessShow?.toDate) {
            ...
            if (toDateInt >= fromDateInt && toDateInt !== 0 && fromDateInt !== 0) {
                ...
                let supportHotel = numberNight * (bussinessShow?.typePeopleInfo?.code == '1A' ? 430000 : 270000)
