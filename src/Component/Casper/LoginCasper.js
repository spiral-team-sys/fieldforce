                ...
                {requestPass ?
                    ...
                    <View style={{ padding: 12, margin: 12, height: '97%', backgroundColor: appcolor.light, borderRadius: 8 }}>
                        ...
                        <View style={{ backgroundColor: appcolor.light, flexGrow: 1 }}>
                            ...
                            <View >
                                <Button
                                    buttonStyle={{ backgroundColor: appcolor.primary, borderRadius: 5 }}
                                    containerStyle={{ alignSelf: 'center', width: '95%', backgroundColor: appcolor.primary }}
                                    titleStyle={{ color: appcolor.light, fontSize: 15, fontWeight: '500' }}
                                    style={{ padding: 5 }}
                                    onPress={handlerLogin}
                                    title='Đăng nhập' />
                                <TouchableOpacity onPress={handlerFogotPassword} >
                                    <Text style={{ width: '100%', padding: 16, fontSize: 15, color: appcolor.dark, textAlign: 'center', fontStyle: 'italic', textDecorationLine: 'underline' }}>Quên mật khẩu?</Text>
                                </TouchableOpacity>
                                <Text style={{ textAlign: 'center', color: appcolor.dark, fontSize: 11 }}>{'Version: ' + versionApp}</Text>
                            </View>
                        </View>
