...
export const ShopProfile = ({ navigation }) => {
  ...
  const renderItem = ({ item, index }) => {
    switch (item.pageName) {
      ...
      case 'WORKINGPLAN':
        return (
          <DashboardWorkingPlan
            key={'WORKINGPLAN_' + index}
            info={item}
      ...
      case 'SELLOUT_HIEND':
        return (
          <DashboardSellOut
            key={'SELLOUT_' + item.pageName + index}
            info={item}
            sendNavigate={navigation}
          />
        );
      ...
      case 'SELLOUT_HIEND_BYMONTH':
        return (
          <DashboardSellOutByMonth
            key={'SELLOUT_BYMONTH_' + item.pageName + index}
            info={item}
            sendNavigate={navigation}
          />
        );
      ...
      case 'SELLIN_BYMONTH':
        return (
          <DashboardSellInByMonth
            key={'SELLIN_BYMONTH' + index}
            info={item}
            sendNavigate={navigation}
          />
        );
      ...
      case 'INVENTORY_TARGET':
        return (
          <DashboardInventoryTarget
            key={'INVENTORY_TARGET_' + index}
            info={item}
            sendNavigate={navigation}
          />
        );
      ...
      case 'DISPLAY_COMPETITOR':
        return (
          <DashboardDisplayCompetitor
            key={'DASHBOARD_DISPLAY_COMPETITOR_' + index}
            info={item}
            sendNavigate={navigation}
          />
        );
      ...
      case 'DISPLAY_SHARE':
        return (
          <DashboardDisplayShare
            key={`DISPLAY_SHARE_${index}`}
            info={item}
            navigation={navigation}
            isReload={loading}
          />
      ...
      case 'DISPLAYSHARE_BYTYPE':
        return (
          <DashboardDisplayShareByType
            key={`DISPLAYSHARE_BYTYPE_${index}`}
            info={item}
            navigation={navigation}
          />
        );
      ...
      case 'SELLOUT_BYWEEK':
        return (
          <DashboardSellOutByWeek
            key={'SELLOUT_BYWEEK_' + index}
            info={item}
            navigation={navigation}
            viewHeight={deviceHeight / 2}
          />
        );
      case 'OOS':
        return (
