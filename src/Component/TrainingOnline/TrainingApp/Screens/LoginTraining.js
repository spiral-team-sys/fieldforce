...
import { onLogin, saveTokenUserToGapp, saveTokenUserTraining } from '../../../../Controller/UserController';
            ...
            <View style={{ justifyContent: 'space-between', alignItems: 'stretch', flex: 1, backgroundColor: appcolor.light }}>
                <View style={{ height: '100%', width: '100%' }}>
                    ...
                    <View style={{ paddingLeft: 12, paddingRight: 12, }}>
                        ...
                        <Text style={{ padding: 3, width: '100%', textAlign: 'center', color: appcolor.dark, marginTop: 20, fontSize: 11 }}>{'Version: 1.0.0'}</Text>
                    </View>
