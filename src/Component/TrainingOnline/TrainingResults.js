...
const RenderViewQRCode = ({
  ...
  return (
    <View style={style.bgQRStyle}>
      <Image
        style={{ width: 300, height: 300, margin: 4 }}
        source={{ uri: QRValue }}
      />
      <View
        style={{
        ...
        >
          ...
          >
            <SpiralIcon
              ...
              solid
              size={18}
              style={{ padding: 3, paddingEnd: 8 }}
            />
            <Text
              style={{ color: appcolor.dark, fontSize: 13, fontWeight: '500' }}
            >
              Sao chép liên kết
            </Text>
          </View>
...
const RenderTrainingResult = ({ style, appcolor, LinkResult, _refWeb }) => {
  return (
    <View style={style.bgQRStyle}>
      <ScrollView
