...
const ExerciseListScreen = ({ navigation }) => {
  ...
  const handlerConfrimExercise = async answerId => {
    ...
    alertConfirm(
      'Xác nhận nộp bài',
      `Bạn có xác nhận muốn nộp bài không?`,
      async () => {
          ...
          {answerDataParse?.videoUri && (
            ...
            >
              ...
              <View style={{ padding: 4 }}>
                <Text
                  style={{ marginTop: 10, fontWeight: 'bold', fontSize: 12 }}
                >
                  Tên: {answerDataParse.name}
                </Text>
                <Text
                  style={{ marginTop: 10, fontWeight: '400', fontSize: 12 }}
                >
                  Gửi lúc:{' '}
                  {moment
                    .utc(answerDataParse.sendDate)
                    .utcOffset(7)
            ...
            <>
              ...
              >
                <View style={{ flexDirection: 'row', marginBottom: 6 }}>
                  ...
                  >
                    Tổng điểm: {answerDataParse?.scoreTotal || 0}
                  </Text>
                </View>
                ...
                {answerDataParse?.leaderNote && (
                  ...
                  >
                    ...
                    <Text style={{ fontSize: 14, fontWeight: '500' }}>
                      Ghi chú: {answerDataParse?.leaderNote}
                    </Text>
                  </View>
                )}
              </TouchableOpacity>
                ...
                {checkTimeSend !== 1 && checkTimeOpen == 1 && (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      handlerSelectSend(
                        item,
                        answerDataParse?.answerId || null,
                        compareTime(itemSetting.editEndTime),
                      )
                    }
                  >
                    <SpiralIcon
    ...
    <View style={{ flex: 1, backgroundColor: '#F2F4F6' }}>
      ...
      >
        <View>
          ...
          >
            <Text
              style={{ color: appcolor.primary, padding: 7, marginBottom: 12 }}
            >
              Áp dụng
            </Text>
          </TouchableOpacity>
