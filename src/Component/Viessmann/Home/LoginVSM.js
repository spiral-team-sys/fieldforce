...
export const LoginVSM = ({ onLoginCallBack }) => {
	...
	const styles = StyleSheet.create({
		...
		titleLogin: { width: '100%', padding: 16, fontSize: scaleSize(28), fontWeight: '700', color: appcolor.dark },
			...
			{requestPass ?
				...
				<View style={styles.mainContainer}>
					<View style={{ width: '100%', height: '20%', marginTop: 32 }}>
						<LottieView autoPlay style={{ height: '100%' }} source={require('../../../Themes/lotties/welcome_vsm.json')} />
					</View>
