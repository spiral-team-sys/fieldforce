		...
		<View style={styles.contentMain}>
			{dataMenu?.match(type.Attendant) &&
				<View key={`db_plan`} style={styles.cardView}>
					<DashboardAttendant navigation={navigation} typeDashboard={type.Attendant} />
				</View>
			}
			{dataMenu?.match(type.SellOut) &&
				<View key={`db_sellout`} style={styles.cardView}>
					<DashboardSellOutVSM navigation={navigation} typeDashboard={type.SellOut} />
				</View>
			}
			{dataMenu?.match(type.SellIn) &&
				<View key={`db_sellin`} style={styles.cardView}>
					<DashboardSellInVSM navigation={navigation} typeDashboard={type.SellIn} />
				</View>
			}
