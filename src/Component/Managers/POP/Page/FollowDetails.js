...
const FollowDetails = ({ itemMain, messageError }) => {
    ...
    const styles = StyleSheet.create({
        mainContainer: { marginTop: 8, padding: 8, backgroundColor: appcolor.light },
        titleOrder: { fontSize: 13, fontWeight: fontWeightBold, color: appcolor.dark, paddingBottom: 4 },
        ...
        viewImage: { width: '30%', overflow: 'hidden', borderRadius: 8, borderWidth: 0.5, borderColor: appcolor.surface },
        viewInfo: { width: '70%', paddingVertical: 8, marginStart: 8 },
        imageView: { width: '100%', height: '100%' },
        titleName: { width: '98%', fontSize: 13, fontWeight: fontWeightBold, color: appcolor.dark },
        titleNumberItem: { color: appcolor.greylight, fontSize: 12, fontWeight: '500' },
        bottomView: { paddingBottom: 32 },
        messageError: { fontSize: 12, fontWeight: '500', color: appcolor.redgray, paddingBottom: 8 }
    })
        ...
        return (
            <View style={styles.itemContainer}>
                ...
                <View style={styles.viewInfo}>
                    ...
                    <Text style={styles.titleNumberItem}>{`Số lượng kho điều chỉnh: ${item.QuantityEdit || 0}`}</Text>
                    <PlusMinusEdit
