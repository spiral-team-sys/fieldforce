...
export const InputDisplayStockCasper = ({
  ...
  const loadDataShow = async () => {
    ...
    await setData({
      dataTab: listTab,
      dataShow: listProduct,
      dataShowF: listProduct,
    });
  ...
  const ViewItem = () => {
    return data.dataTab.map(it => {
      ...
      let listDataByCate = data.dataShow.filter(
        item => item.categoryId === it.categoryId,
      );
        ...
        >
          <View style={Style.viewTabStyle}>
            ...
            <FlashList
              ...
              ListFooterComponent={
                <Text style={Style.footerStyle}>Đã xem hết</Text>
              }
  ...
  return (
    <View style={Style.container}>
      <View style={Style.headerStyle}>
        ...
        />
        <TouchableOpacity onPress={openSheet} style={Style.buttonHeaderStyle}>
          <SpiralIcon
      ...
      >
        <View style={Style.actionSheetStyle}>
          <View style={{ width: '100%' }}>
            ...
            >
              <Text style={[Style.textSheetStyle, { color: appcolor.dark }]}>
                Sản phẩm đã nhập
              </Text>
              <SpiralIcon
            ...
            <TouchableOpacity
              ...
              onPress={setClearAll}
            >
              <Text style={[Style.textSheetStyle, { color: appcolor.danger }]}>
                Xóa dữ liệu đã nhập
              </Text>
              <SpiralIcon
                name={'trash'}
