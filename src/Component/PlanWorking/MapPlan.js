...
export const MapPlan = ({ navigation, route }) => {
    ...
    return (
        <View style={{ flex: 1, }} >
            ...
            <View style={{
                position: 'absolute', flexDirection: 'row', flex: 1,
                zIndex: 5, bottom: 20, justifyContent: 'center', paddingLeft: 12
            }}>
                <TouchableOpacity
                ...
                </TouchableOpacity>
                {
                    ...
                    <TouchableOpacity
                        onPress={() => moveToRoute()}
                        style={{ height: 50, width: 50, justifyContent: 'center', marginEnd: 7, borderRadius: 40, alignSelf: 'center' }}>
                        <Icon
                            color={appcolor.info} reverse
                            name='directions'
                            size={24} />
                    </TouchableOpacity>
                }
            ...
            <Button title="Tìm cửa hàng..."
                ...
                containerStyle={{
                    ...
                    top: 50, left: 20, right: 20, borderRadius: 30, opacity: 0.8,
                    position: 'absolute', color: appcolor.dark, padding: 7,
                    backgroundColor: appcolor.white,
                }} />

            <ActionSheet gestureEnabled id='sheetProfile'
                nestedScrollEnabled={true} drawUnderStatusBar
