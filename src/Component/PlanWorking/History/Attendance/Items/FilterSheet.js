    ...
    <View style={styles.container}>
      <TouchableOpacity
        style={[
          styles.optionBtn,
          {
            backgroundColor: getBackgroundColor('EMPLOYEE'),
      ...
      >
        <Text
          style={[
            styles.titleName,
            styles.titleNameView,
            { color: getTextColor('EMPLOYEE') },
          ]}
        >
          Nhân viên
        </Text>
      ...
      <TouchableOpacity
        style={[
          styles.optionBtn,
          {
            backgroundColor: getBackgroundColor('SHOP'),
            borderColor: getBorderColor('SHOP'),
          },
        ]}
