          ...
          if (listModified.length > 0) {
            ...
            for (let i = 0, lenList = listModified.length; i < lenList; i++) {
              ...
              if (
                ...
                errorStr =
                  'Vui lòng nhập ghi chú lí do ' +
                  (confirmLate === REJECT_VALUE(typeId)
                    ? 'không xác nhận'
                    : 'xác nhận') +
                  ' đi trễ cửa hàng ' +
                  shopName +
              ...
              if (
                ...
                errorStr =
                  'Vui lòng nhập ghi chú lí do ' +
                  (confirmEarlier === REJECT_VALUE(typeId)
                    ? 'không xác nhận'
                    : 'xác nhận') +
                  ' về sớm cửa hàng ' +
                  shopName +
  ...
  const onFilterContentBS = value => {
    ...
    if (value) {
      const filterList = listFilter.filter(e => {
        ...
        return removeVietnameseTones(labelFilter.toLowerCase()).includes(
              ...
              <View style={styles.countRow}>
                <View style={styles.countCell}>
                  <Text style={styles.countNumber}>
                    {item.countChangeShift}
                  </Text>
                  <Text style={styles.countLabel}>
                    {item.titleChangeShift}{' '}
                  </Text>
                </View>
                <View style={styles.countCell}>
