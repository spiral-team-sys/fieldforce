          ...
          >
            ...
            >
              ...
              <ListItem.Title
                style={[
                  styles.itemShopText,
                  { fontWeight: '700', fontSize: 15, width: '70%' },
                ]}
              >
                {item.shopName}
              </ListItem.Title>
      ...
      <View style={{ flex: 1 }}>
        {item.isParent && (
          ...
          >
            ...
            />
            <ListItem.Title style={{ color: appcolor.black, fontSize: 16 }}>
              Nhân viên: {item.employeeName}
            </ListItem.Title>
          </View>
        )}
        {item.isParent && (
          <View style={styles.viewPhep}>
            <Text style={styles.titlePhep}>{`Phép tồn: ${item.phepTon}`}</Text>
            <Text
              style={styles.titlePhep}
            >{`Phép đã được duyệt: ${item.phepConfirm}`}</Text>
          </View>
        )}
        <View key={index}>
