...
const LG_ConfirmPlanMD = ({ navigation, route }) => {
            ...
            <View style={{ flex: 1 }}>
                ...
                {item.isParent &&
                    <View style={styles.viewPhep}>
                        ...
                        <Text style={styles.titlePhep}>{`Phép đã được duyệt: ${item.phepConfirm}`}</Text>
                    </View>
                }
                <View key={index}>
    ...
    const styles = StyleSheet.create({
        ...
        viewPhep: { width: '100%', padding: 8, borderBottomWidth: 0.5, borderBottomColor: appcolor.greylight },
        titlePhep: { fontSize: 14, fontWeight: fontWeightBold, color: appcolor.primary }
    })
    useEffect(() => {
