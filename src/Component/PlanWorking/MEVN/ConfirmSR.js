...
const ConfirmSR = ({ navigation, route }) => {
        ...
        {item.isParent && (
          <View style={[styles.titleContainer, { marginLeft: 12 }]}>
            <SpiralIcon
              ...
              name="user"
              size={18}
              style={{ color: appcolor.primary, paddingEnd: 8 }}
            />
            <ListItem.Title
              style={{
            ...
            {item[`${item.employeeId}${item.auditDate}`] && (
              <View>
                <View style={[styles.titleContainer, { marginStart: 8 }]}>
                  ...
                  />
                  <ListItem.Title
                    style={{ color: appcolor.dark, fontSize: 16 }}
                  >
                    {item.dayName}
                  </ListItem.Title>
                </View>
  ...
  return (
    <View style={{ flex: 1 }}>
      <HeaderCustom
        title={route?.params?.titlePage || 'Xác nhận lịch làm  việc SR'}
      ...
      <View style={styles.mainContainer}>
        ...
        {!refreshing && data.length === 0 && (
          ...
          >
            <Text style={{ color: appcolor.onBackground, fontSize: 18 }}>
      ...
      renderItem={({ item, index }) => {
        ...
        return (
          <ListItem
            ...
            containerStyle={{
              backgroundColor: isExists ? appcolor.primary : appcolor.light,
            }}
          >
            <ListItem.Content
              style={{
