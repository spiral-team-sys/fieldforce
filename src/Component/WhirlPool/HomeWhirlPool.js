          ...
          >
            ...
            >
              <View style={{ width: 50, justifyContent: 'center' }}>
                ...
                >
                  <SpiralIcon name="menu" size={scaleSize(30)} />
                </TouchableOpacity>
              </View>
            ...
            >
              ...
              <View style={{ backgroundColor: appcolor.light }}>
                <View style={{ flexDirection: 'row' }}>
                  ...
                  {/* <SpiralIcon color={appcolor.dark} containerStyle={{ marginRight: 12, alignSelf: 'center' }} name="ellipsis-h" type="font-awesome-5" /> */}
                </View>
                <View>
