...
export const WorkEarlier = ({ dataDetail, itemMain }) => {
	...
	return (
		<View style={styles.mainContainer}>
			...
			<View style={styles.contentSummary}>
				...
				{/* // Status Confirm */}
				{itemData.WPEarlierConfirmNote !== null && itemData.WPEarlierConfirmNote !== undefined && <Text style={styles.descriptionSummary}>{`QL ghi chú: ${itemData.WPEarlierConfirmNote}`}</Text>}
			</View>
			<View style={styles.viewStatus}>
				<View style={{ backgroundColor: appcolor[itemData.colorStatusName], borderRadius: 20, padding: 5, overflow: 'hidden' }} >
					<Icon name={itemData.iconStatusName} size={18} color={(itemData?.WPEarlierConfirm || null) !== null ? appcolor.light : appcolor.dark} />
				</View>
			</View>
		</View>
	)
