    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.contentSummary}>
        ...
        {itemData.WPEarlier && (
          ...
          >{`Thời gian: ${itemData.WPEarlier}`}</Text>
        )}
        {itemData.WPEarlierNote && (
          <Text style={styles.descriptionSummary}>
            {itemData.WPEarlierNote}
          </Text>
        )}
        {/* // Status Confirm */}
        {itemData.WPEarlierConfirmNote !== null &&
          itemData.WPEarlierConfirmNote !== undefined && (
            <Text
              style={styles.descriptionSummary}
            >{`QL ghi chú: ${itemData.WPEarlierConfirmNote}`}</Text>
          )}
      </View>
      <View style={styles.viewStatus}>
        ...
        >
          <SpiralIcon
            ...
            size={18}
            color={
              (itemData?.WPEarlierConfirm || null) !== null
                ? appcolor.light
                : appcolor.dark
            }
          />
