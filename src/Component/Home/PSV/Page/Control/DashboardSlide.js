            ...
            >
                <View style={styles.slideHeaderRow}>
                    <View style={styles.slideIcon}>
                        <Icon name={item.icon} type="feather" size={17} color={appcolor.white} />
                    </View>
                    <View style={styles.slideTitleWrap}>
                        <Text numberOfLines={1} style={styles.slideTitle}>{item.title}</Text>
                        <Text numberOfLines={1} style={styles.slideSubtitle}>{item.subtitle}</Text>
                    </View>
                    <View style={styles.slideBadge}>
                        <Text numberOfLines={1} style={styles.slideBadgeText}>{item.type}</Text>
                    </View>
                </View>
            </LinearGradient>
