...
const HomeOffice = ({ navigation, isReloadData }) => {
    ...
    const styles = StyleSheet.create({
        ...
        contentContainer: { width: '100%', height: deviceHeight, backgroundColor: appcolor.surface, padding: 16 }
    })
    return (
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={styles.contentContainer}>
                <CustomListView
                    ...
                    renderItem={() => { return <SummaryOffice navigation={navigation} isLoadMain={isReloadData} /> }}
