...
const HeaderView = ({ navigation }) => {
    ...
    const styles = StyleSheet.create({
        ...
        viewTop: { borderTopRightRadius: deviceWidth / 3, opacity: 0.5, backgroundColor: appcolor.grayLight, width: '50%', position: 'absolute', top: -60, bottom: 0, start: 0 },
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={styles.contentMain}>
                <View style={styles.contentTitle}>
                    <Text numberOfLines={1} style={styles.titleWelcome}>{`Xin chào, ${userinfo.fisrtName || userinfo.employeeName}`}</Text>
                ...
                <View style={styles.contentButton}>
                    <TouchableOpacity style={styles.buttonAction} onPress={handlerNotifyPress}>
                        <Icon reverse size={20} color={appcolor.success} type="iconic" name='notifications' />
                        {countNotification > 0 &&
                    ...
                    <TouchableOpacity style={styles.buttonAction} onPress={handlerMenuPress}>
                        <Icon reverse size={20} color={appcolor.primary} type="iconic" name='menu' />
                    </TouchableOpacity>
                </View>
            </View>
            <TouchableOpacity style={styles.contentSummary} onPress={handlerShowDashboard} >
                ...
                <View style={styles.itemSummary}>
                    <TouchableOpacity onPress={LoadData}>
                        <Icon reverse name="trending-up" color={appcolor.primary} size={24} />
                    </TouchableOpacity>
                </View>
                <View style={styles.itemSummary}>
