...
const HomeLG = ({ navigation, isReloadData }) => {
    ...
    const styles = StyleSheet.create({
        ...
        contentDashboard: { width: '100%', height: deviceHeight / 5, backgroundColor: appcolor.primary, borderTopStartRadius: 50, borderTopEndRadius: 50, padding: 8, overflow: 'hidden' },
