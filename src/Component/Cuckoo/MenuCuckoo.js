...
export const MenuCuckoo = ({ navigation, menus }) => {
                        ...
                        return (
                            <TouchableOpacity style={{ width: deviceWidth / 3, alignItems: 'center' }} key={"kkd2-" + index} onPress={() => handlerItemClick(item)}>
                                <Avatar
                                    ...
                                    containerStyle={{ backgroundColor: ColorRand(index + 3) }}
                                />
                                <Text numberOfLines={2} style={{
                                    padding: 7, textAlign: 'center', width: deviceWidth / 3, fontSize: scaleSize(12),
                                    color: appcolor.dark,
