...
import LoginCuckoo from './LoginCuckoo';
                    ...
                    this.state.welcome === 1 ?
                        ...
                        (userinfo.employeeId > 0 ?
                            <SafeAreaView style={{ backgroundColor: appcolor.primary }}>
                                ...
                                {/* <TouchableOpacity onPress={() => this.props.navigation.navigate("reporttimesheet")}>
                                    <Text>New form</Text>
                                </TouchableOpacity> */}
                                <ScrollView
                                    showsVerticalScrollIndicator={false}
                                    style={{ backgroundColor: appcolor.light, paddingBottom: 80 }}
                                    ...
                                    <View style={{ backgroundColor: appcolor.light }}>
                                        <View style={{
                                            ...
                                            <View style={{ flex: 1, borderBottomRightRadius: 40 }}>
                                                <QuickViewCuckoo navigation={this.props.navigation} />
                                            </View>
                                        </View>
                                        <View style={{ minHeight: 180 }}>
                                            <Text style={{ padding: 7, fontWeight: '900', color: appcolor.dark }}>Chức năng</Text>
                                            <MenuCuckoo navigation={this.props.navigation} menus={this.state.menus} />
                                        </View>
                                        <View style={{ backgroundColor: appcolor.light }}>
                            ...
                            : <LoginCuckoo onLoginCallBack={() => this.SyncdataApp()} />
                        )
                }
            </Fragment>
        );
...
export default connect(mapStateToProps, mapDispathToProps)(HomeCuckoo)
