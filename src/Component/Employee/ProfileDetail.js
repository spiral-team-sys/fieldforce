            ...
            return (
              <View key={'lpl-' + index} style={styles.planRow}>
                <View style={styles.planLeft}>
                  ...
                  >
                    <Text
                      style={{ color: appcolor.dark, fontSize: scaleSize(16) }}
                    >
                      {i.Day}
                    </Text>
                    <Text
                  ...
                  <View
                    style={[
                      {
                        display: index === detail.length - 1 ? 'none' : 'flex',
                      },
                      styles.planLine,
                    ]}
                  />
                ...
                <View style={styles.planRight}>
                  <Text numberOfLines={2} style={styles.planShop}>
                    CH: {i.ShopName}
                  </Text>
                  <Text style={styles.planShift}>
                    Ca làm việc: {i.ShiftType}
                  </Text>
                  <View
                    style={[
                      {
        ...
        <View style={styles.sellRow}>
          ...
          <View style={styles.sellCol}>
            <View style={styles.sellColA}>
              <SpiralIcon name="money" color={appcolor.primary} size={24} />
            </View>
            <Text style={styles.sellValue}>
              {current.Amount ? (current.Amount / 1000000).toFixed(2) : '-'} M
            </Text>
          ...
          <View style={styles.sellCol}>
            <View style={styles.sellColQ}>
              <SpiralIcon name="percent" color={appcolor.primary} size={24} />
            </View>
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.headerContainer}>
        ...
        >
          <SpiralIcon name="chevron-left" color={appcolor.dark} size={20} />
        </TouchableOpacity>
