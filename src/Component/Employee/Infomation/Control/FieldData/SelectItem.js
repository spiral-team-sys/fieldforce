...
export const SelectItem = ({ itemMain, keyValue }) => {
    ...
    const styles = StyleSheet.create({
        ...
        titleHeader: { fontSize: 15, fontWeight: fontWeightBold, color: appcolor.blacklight, marginBottom: 8 },
        itemMain: { width: '100%', paddingVertical: 5, borderBottomColor: appcolor.grayLight, borderBottomWidth: 0.5 }
    })
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            />
            <ActionSheet id={`selectitem_${itemMain.ItemId}`} containerStyle={styles.sheetContent}>
