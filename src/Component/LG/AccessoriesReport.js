...
import {
  getListCategoryAccessories,
  getListItemAccessories,
  getListTypeAccessories,
  getLstAccessResult,
  getLstAccessUpload,
...
const AccessoriesReport = ({ navigation, route }) => {
  ...
  const uploadAction = async () => {
    ...
    Message(
      ...
      () => UploadData(itemsUp, work),
    );
  };
  const UploadData = async (itemsUp, work) => {
    await setProgress(true);
    await UploadController.DataAccessories(
      itemsUp,
      work,
      async () => {
