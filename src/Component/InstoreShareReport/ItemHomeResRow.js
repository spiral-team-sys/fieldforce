    ...
    >
      ...
      >
        <View style={{ padding: 4, width: '80%' }}>
          ...
          >
            Hãng : {<Text>{item.competitorName}</Text>}{' '}
          </Text>
          {item.categoryName !== undefined && item.categoryName !== null && (
            <Text
              style={{ fontWeight: '500', fontSize: 12, color: appcolor.dark }}
            >
              Ngành hàng : {<Text>{item.categoryName}</Text>}{' '}
            </Text>
          )}
          {item.year !== undefined &&
            ...
            item.month !== null && (
              ...
              >
                Tháng : {<Text>{`${item.month}-${item.year}`}</Text>}{' '}
              </Text>
            )}
          {item.note !== undefined &&
            item.note !== null &&
        ...
        >
          ...
          >
            <Text
              style={{ fontWeight: '500', fontSize: 16, color: appcolor.white }}
            >
              {' '}
