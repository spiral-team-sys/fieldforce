...
export const ControlActionData = ({
  ...
  const handlerFile = async () => {
    ...
    await NativeCamera.imageGalleryLaunch(
      photoinfo,
      () => {
        handlerLoadPhoto();
      },
  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
        {!cancelEvident && !notVerifyEvident && infoVerify && (
          ...
          >
            <Text
              style={{
                ...styles.textView,
                color: isInfoUpdate ? appcolor.light : appcolor.dark,
              }}
            >
              {'Cập nhật'}
            </Text>
        ...
        {!cancelEvident && !notVerifyEvident && itemChild.isImageVAT == 1 && (
          ...
          >
            <Text
              style={{
                ...styles.textView,
                color: isVAT ? appcolor.light : appcolor.dark,
              }}
            >
              {'VAT'}
            </Text>
        ...
        {!cancelEvident && !notVerifyEvident && itemChild.isImageBill == 1 && (
          ...
          >
            <Text
              style={{
                ...styles.textView,
                color: isBILL ? appcolor.light : appcolor.dark,
              }}
            >
              {itemChild.titleButton || 'Biên nhận'}
            </Text>
          </TouchableOpacity>
        )}
        {!cancelEvident && !notVerifyEvident && itemChild.isImageCRM == 1 && (
          ...
          >
            <Text
              style={{
                ...styles.textView,
                color: isCRM ? appcolor.light : appcolor.dark,
              }}
            >
              {'CRM'}
            </Text>
        ...
        {!cancelEvident && !notVerifyEvident && itemChild.isImageFSM == 1 && (
          ...
          >
            <Text
              style={{
                ...styles.textView,
                color: isFSM ? appcolor.light : appcolor.dark,
              }}
            >
              {'FSM'}
            </Text>
        ...
        {!cancelEvident && itemChild.isNotVerify == 1 && (
          <TouchableOpacity
            ...
            style={{
              ...styles.buttonView,
              backgroundColor: notVerifyEvident ? appcolor.red : appcolor.light,
            }}
          ...
          >
            <Text
              style={{
                ...styles.textView,
                minWidth: 30,
                color: notVerifyEvident ? appcolor.light : appcolor.red,
              }}
            >
              {itemChild.titleNotVerify || 'không xác minh'}
            </Text>
          </TouchableOpacity>
        )}
        {!notVerifyEvident && (
          <TouchableOpacity
            ...
            style={{
              ...styles.buttonView,
              backgroundColor: cancelEvident ? appcolor.red : appcolor.light,
            }}
          ...
          >
            <Text
              style={{
                ...styles.textView,
                minWidth: 30,
                color: cancelEvident ? appcolor.light : appcolor.red,
              }}
            >
              Hủy
            </Text>
      ...
      <ActionSheet
        id={`modePicture_${itemChild.SaleId}`}
        gestureEnabled
        ...
        >
          ...
          <View style={styles.actionCamera}>
            ...
            <TouchableOpacity
              ...
              onPress={handlerFile}
            >
              <SpiralIcon name="attach-file" color={appcolor.light} size={25} />
            </TouchableOpacity>
          </View>
          {/* Content Action */}
      ...
      >
        ...
        >
          ...
          <View style={styles.actionCamera}>
            ...
            >
              <SpiralIcon name="save" color={appcolor.light} size={25} />
            </TouchableOpacity>
          </View>
          <ScrollView nestedScrollEnabled>
            {dataUpdateInfo !== null &&
              dataUpdateInfo.length > 0 &&
              dataUpdateInfo.map((i, ix) => {
