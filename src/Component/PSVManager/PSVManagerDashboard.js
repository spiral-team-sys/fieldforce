...
import { PSVManagerSONW, PSVManagerSObyRegion, PSVManagerSObyDealer, PSVManagerSObyCate, PSVManagerSOTopStore, PSVManagerSOTopSKU } from '../../Controller/PSVManagerController';
        ...
        <SafeAreaView>
            ...
            <ScrollView showsVerticalScrollIndicator={false}
                ...
                <View style={{ backgroundColor: appcolor.surface }}>
                    ...
                    {
                        data2.length > 0 &&
                        <ChartByRegion key="2" chartdata={data2} />
                    }
                    {
                        data3.length > 0 &&
                        <ChartByDealer key="3" chartdata={data3} />
                    }
                    {
                        data4.length > 0 &&
                        <ChartBySubCate key="4" chartdata={data4} />
                    }
                    {
                        data5.length > 0 &&
                        <ChartTopStore key="5" chartdata={data5} />
                    }
                    {
                        data6.length > 0 &&
                        <ChartTopSKU key="6" chartdata={data6} />
                    }
