...
import { PSVManagerSOTopSKU } from '../../Controller/PSVManagerController';
const chartConfig = {
    legend: {
        enabled: false,
        textSize: 10,
...
export const ChartTopSKU = ({ chartdata }) => {
    ...
    return (
        <View style={{ height: 320 ,marginBottom:12}}>
            <Text style={{ backgroundColor: 'white', padding: 5, color: '#1557c1', fontSize: 16, textAlign: 'center', fontWeight: 'bold', }}>Sellout top 10 SKU</Text>
            <BarChart
