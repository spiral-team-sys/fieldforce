...
export const SummarySharp = ({ navigation }) => {
    ...
    const styles = StyleSheet.create({
        ...
        cardView: { width: '100%', backgroundColor: appcolor.surface, borderRadius: 35, marginBottom: 10, overflow: 'hidden', padding: 4 },
        ...
        <View style={styles.contentMain}>
            ...
            {dataMenu?.match(type.Routing) &&
                <View key={`db_route`} style={styles.cardView}>
                    <DashboardRoute navigation={navigation} typeDashboard={type.Routing} />
                </View>
            }
        </View>
    )
