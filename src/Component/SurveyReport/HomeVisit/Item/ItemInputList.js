...
import { getItemInputType, getKeyboardType, mergeListInputItems, sanitizeItemValue } from "./ItemHelpers";
...
const ItemInputList = ({ item, onUpdateItem }) => {
    ...
    const styles = StyleSheet.create({
        ...
        titleName: { fontSize: 13, fontWeight: fontWeightBold, color: appcolor.dark, marginBottom: 6 },
    ...
    return (
        <View style={styles.mainContainer}>
            {listInputs.map((inputItem, index) => {
                ...
                return (
                    <View key={`${inputItem.ItemId}_${index}`} style={styles.itemContainer}>
