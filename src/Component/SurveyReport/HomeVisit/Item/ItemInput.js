...
import { getItemInputType, getKeyboardType, sanitizeItemValue } from "./ItemHelpers";
...
const ItemInput = ({ item, onUpdateItem }) => {
    ...
    const styles = StyleSheet.create({
        ...
        inputContainer: { borderRadius: 8, borderColor: valueInput ? appcolor.grayLight : appcolor.red, borderWidth: 0.5, marginTop: 8 },
    ...
    return (
        <View style={styles.mainContainer}>
            <FormGroup
                ...
                placeholder={item?.DescriptionName || `Nhập ${item?.ItemName?.toLowerCase() || 'thông tin'}`}
                value={valueInput}
