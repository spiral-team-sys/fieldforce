...
import { View, Text, AppState, RefreshControl, ScrollView, TouchableOpacity } from 'react-native';
                                        ...
                                        } */}
                                        {
                                            ...
                                            <View style={{ height: 240, paddingEnd: 0 }}>
                                                <ScrollView
                                                    ...
                                                    pagingEnabled
                                                    scrollEnabled={true}
                                                    contentContainerStyle={{ width: (chartdata.length * deviceWidth) - 14 }}
                                                    horizontal
                                                >
                                                    {
                                                        chartdata.map((it, idx) => {
                                                            if (it.pageName == 'SELLOUT') {
                                                                ...
                                                                return <View style={{ minHeight: 120, width: deviceWidth - 14 }} key={`page${idx}`}>
                                                                    <DashboardMevn data={chart} />
                                                                </View>
                                                            } else if (it.pageName == 'SELLIN') {
                                                                return <View key={`db_Sellin`} style={{ width: deviceWidth - 14, backgroundColor: appcolor.light, borderRadius: 0, marginBottom: 10, overflow: 'hidden', padding: 4 }}>
