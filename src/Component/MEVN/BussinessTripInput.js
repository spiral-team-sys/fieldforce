        ...
        if (bussinessInput?.fromDate && bussinessInput?.toDate) {
            ...
            if (toDateInt >= fromDateInt) {
                ...
                if (bussinessInput?.typeKm) {
                    ...
                    let price = bussinessInput?.typeKmInfo.numberValue || 0;
            ...
            // Fetch data by date
            // getListWorkingSchedule();
        }
        // console.log(bussinessInput,"CalculatorBy")
    }
    useEffect(() => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: appcolor.light }}>
            ...
            <Button containerStyle={{
                ...
                onPress={() => continueView()} title={'Tiếp tục'}></Button>
            <ActionSheet
                ref={_bottomSheet}
