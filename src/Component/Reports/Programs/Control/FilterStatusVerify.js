    ...
    return (
        <View style={styles.filterSheetContent}>
            ...
            {showCreateByFilter && (
                <View style={styles.createByContainer}>
                    ...
                    <FormGroup
                        ...
                        containerStyle={{ marginBottom: 0, borderColor: appcolor.grayLight, backgroundColor: appcolor.white }}
                    ...
                    {suggestedCreators?.length > 12 && (
                        <Text style={styles.suggestionMoreText}>Hiển thị 12/{suggestedCreators.length} gợi ý</Text>
                    )}
                </View>
            )}
            {showDealerFilter && (
                <View style={styles.dealerContainer}>
                    ...
                    {suggestedDealers?.length > 12 && (
                        <Text style={styles.suggestionMoreText}>Hiển thị 12/{suggestedDealers.length} gợi ý</Text>
                    )}
                </View>
            )}
                ...
                <View key={item.sectionTitle} style={styles.filterSectionBlock}>
                    <View style={styles.filterSectionRow}>
                        <View style={styles.filterSectionInfo}>
                            <Icon type="ionicon" name={item.iconName} size={18} color={appcolor.primary} />
                        ...
                        <View style={styles.statusGroup}>
                            <TouchableOpacity
                                style={[
                                    styles.statusButton,
                                    selectedType === item.unverifiedType && styles.statusButtonActive,
                                ]}
                                activeOpacity={0.85}
                            ...
                            >
                                <Text
                                    style={[
                                        styles.statusLabel,
                                        selectedType === item.unverifiedType && styles.statusLabelActive,
                                    ]}
                                >
                                    Chưa gửi
                                </Text>
                            ...
                            <TouchableOpacity
                                style={[
                                    styles.statusButton,
                                    selectedType === item.verifiedType && styles.statusButtonActive,
                                ]}
                                activeOpacity={0.85}
                            ...
                            >
                                <Text
                                    style={[
                                        styles.statusLabel,
                                        selectedType === item.verifiedType && styles.statusLabelActive,
                                    ]}
                                >
                                    Đã gửi
                                </Text>
            ...
            <View style={styles.actionRow}>
                <TouchableOpacity style={[styles.actionButton, styles.clearButton]} activeOpacity={0.85} onPress={onClearFilter}>
                    <Text style={styles.clearButtonText}>Xoá lọc</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.actionButton, styles.applyButton]} activeOpacity={0.85} onPress={onApplyFilter}>
