  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.title}>Lọc kết quả chương trình</Text>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Kết quả chương trình</Text>
          ...
          {localFilter.timeMode !== 'ALL' && (
            <View>
              {localFilter.timeMode === 'QUARTER' && (
                <View>
                  <Text style={styles.monthQuarterLabel}>Quý</Text>
                  <View style={styles.chipRow}>
                    {quarterList.map(q => {
