...
import { DEFAULT_SUMMARY_FILTER_SORT, SUMMARY_SORT_OPTIONS, SUMMARY_STATUS_OPTIONS } from "../Control/summaryFilterSort";

const SummaryFilterSortPanel = ({ appcolor, value = DEFAULT_SUMMARY_FILTER_SORT, onChange, isSheet = false }) => {
    const sortOptions = [
    ...
    const styles = StyleSheet.create({
        ...
        subtitle: { fontSize: 11, color: appcolor.placeholderText || appcolor.dark, marginTop: 3, fontWeight: '600' },
        resetText: { fontSize: 11, fontWeight: '700', color: appcolor.primary },
        sectionTitle: { fontSize: 11, fontWeight: '800', color: appcolor.placeholderText || appcolor.dark, marginBottom: 8, letterSpacing: 0.3 },
        ...
        <View style={styles.container}>
            <View style={styles.headerRow}>
                <View>
                    ...
                    <Text style={styles.subtitle}>Thu gọn dữ liệu trước khi đọc dashboard</Text>
                </View>
