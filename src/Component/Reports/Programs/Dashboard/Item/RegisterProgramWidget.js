    ...
    ? [
        {
          key: 'rp',
          label: 'Đã đăng ký',
          value: metrics.registerPass,
          color: passColor,
        },
        {
          key: 'rf',
          label: 'Chưa đăng ký',
          value: metrics.registerFail,
          color: failColor,
        },
        {
          key: 'ro',
          ...
          value: Math.max(
            0,
            metrics.registerTotal - metrics.registerPass - metrics.registerFail,
          ),
    ...
    ? [
        {
          label: 'Đã đăng ký',
          value: metrics.registerPass,
          valueStyle: { color: passColor },
        },
        {
          label: 'Chưa đăng ký',
          value: metrics.registerFail,
          valueStyle: { color: failColor },
        },
        {
          label: 'Tổng chương trình',
          value: metrics.registerTotal,
          valueStyle: { color: neutralColor },
          isDivider: true,
        },
      ]
    : [];
