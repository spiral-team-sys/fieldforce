...
const ReviewDisplay = ({ data, onChangeData }) => {
    ...
    const styles = StyleSheet.create({
        ...
        noteInput: { fontSize: 13, color: appcolor.dark, backgroundColor: appcolor.light, borderRadius: 8, borderWidth: 1, borderColor: appcolor.grayLight, minHeight: 80, textAlignVertical: 'top' },
    })
    ...
    return (
        <View style={styles.contentContainer}>
            ...
            <ButtonGroup
                ...
                selectedButtonStyle={{ backgroundColor: passed == 1 ? appcolor.primary : appcolor.danger }}
                containerStyle={{ height: 38, marginTop: 8, borderRadius: 8, borderWidth: 1, borderColor: appcolor.grayLight }}
                textStyle={{ fontSize: 12, color: appcolor.dark, fontWeight: fontWeightBold }}
