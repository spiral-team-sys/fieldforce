      ...
      <View style={styles.listOptionWrap}>
        {options
          ...
          .map((item, index) => {
            ...
            const onPressToggle = () =>
              onSelect(keyName, isActive ? 'ALL' : item);
            if (renderItem) {
              return (
                <React.Fragment key={`${keyName}_list_${index}`}>
                  {renderItem(item, isActive, onPressToggle)}
                </React.Fragment>
              );
            }
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.listOptionItem,
                  isActive && styles.listOptionItemActive,
                ]}
              ...
              >
                <Text
                  style={[
                    ...
                    isActive && styles.listOptionTitleActive,
                  ]}
                >
                  {item}
                </Text>
                {!!subTitle && (
                  <Text
                    style={[
                      styles.listOptionSubTitle,
                      isActive && styles.listOptionSubTitleActive,
                    ]}
                  >
                    {subTitle}
                  </Text>
