 ...
 */
const ProvinceItem = ({ name, employeeCount, shopCount, isActive, onPress }) => {
    ...
    return (
        <TouchableOpacity style={[styles.item, isActive && styles.itemActive]} onPress={onPress}>
            ...
            <Text style={[styles.count, isActive && styles.countActive]}>{`${shopCount} cửa hàng • ${employeeCount} nhân viên`}</Text>
        </TouchableOpacity>
    )
}
