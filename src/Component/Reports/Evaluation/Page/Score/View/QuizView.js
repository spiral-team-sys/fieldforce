            ...
            >
                ...
                <View style={styles.questionCard}>
                    <View style={styles.questionMeta}>
                        {currentQ.groupName && <View style={styles.groupTag}><Text style={styles.groupTagText}>{currentQ.groupName}</Text></View>}
                        <Text style={styles.questionNumber}>{`${currentIndex + 1} / ${total}`}</Text>
                    </View>
                </View>
                {/* Score input */}
        ...
        <View style={styles.navRow}>
            ...
            <TouchableOpacity
                style={[
                    ...
                    currentIndex === total - 1 && !allQuestionsAnswered && styles.navBtnPrimaryDisabled,
                    currentIndex < total - 1 && !currentTargetsAnswered && styles.navBtnPrimaryDisabled,
                ]}
                onPress={currentIndex < total - 1 ? onNext : onSubmit}
                disabled={(currentIndex === total - 1 && !allQuestionsAnswered) || (currentIndex < total - 1 && !currentTargetsAnswered)}
            >
