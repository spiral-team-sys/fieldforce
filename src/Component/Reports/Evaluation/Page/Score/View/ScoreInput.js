    ...
    <>
              ...
              <View style={styles.targetItemWrap}>
                ...
                >
                  <View style={styles.targetItemLeft}>
                    <Text style={styles.targetItemLabel} numberOfLines={1}>
                      {target.label}
                    </Text>
      ...
      <View style={styles.scorePanel}>
        <View style={styles.scorePanelHeader}>
          {currentMode === 'subItems' && (
            <Text
              style={styles.scorePanelTitle}
            >{`${activeTarget.label}`}</Text>
          )}
          {currentScore == null && (
            <Text style={styles.scorePanelMode}>Chưa chấm điểm</Text>
          )}
        </View>
        <View style={styles.scoreRow}>
          ...
          >
            <SpiralIcon
              ...
              name="remove"
              size={20}
              color={canDown ? appcolor.primary : appcolor.grayLight}
            />
          </TouchableOpacity>
          ...
          >
            <SpiralIcon
              ...
              name="add"
              size={20}
              color={canUp ? appcolor.primary : appcolor.grayLight}
            />
          </TouchableOpacity>
        </View>
        ...
        <TextInput
          ...
          onChangeText={text =>
            setNotes(prev => ({ ...prev, [activeTarget.key]: text }))
          }
