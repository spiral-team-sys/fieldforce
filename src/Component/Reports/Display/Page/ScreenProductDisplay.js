...
export const ScreenProductDisplay = ({}) => {
  ...
  const { appcolor, shopinfo, kpiinfo, isEdit, isLoading, isStartDisplay } =
  ...
  const handlerChangePosition = async itemUpdate => {
    ...
    console.log(
      '[handlerChangePosition] isDisplayAreaList:',
      isDisplayAreaList,
    );
    console.log(
      '[handlerChangePosition] keyValue:',
      itemChooseAction?.item?.keyValue,
    );
    console.log(
      '[handlerChangePosition] itemUpdate.DisplayArea:',
      itemUpdate.DisplayArea,
    );
    console.log(
      '[handlerChangePosition] itemUpdate.NoteProduct:',
      itemUpdate.NoteProduct,
    );
    console.log(
      '[handlerChangePosition] itemUpdate.Display:',
      itemUpdate.Display,
    );
    ...
    //
    const updatedItem = dataUpdate.find(
      e => e.ProductId == itemUpdate.ProductId,
    );
    console.log(
      '[handlerChangePosition] result DisplayArea:',
      updatedItem?.DisplayArea,
    );
    console.log(
      '[handlerChangePosition] result NoteProduct:',
      updatedItem?.NoteProduct,
    );
    console.log(
      '[handlerChangePosition] result Display:',
      updatedItem?.Display,
    );
