...
const LoginSignify = ({ onLogin, isLoading, onFogetPassword, onShowPrivacy }) => {
    ...
    const styles = StyleSheet.create({
        ...
        titleStyle: { fontSize: 12, fontWeight: fontWeightBold, color: appcolor.primary, padding: 5 },
        ...
        actionContainer: { flexDirection: 'row', alignItems: 'center', padding: 16, marginTop: 16 },
        buttonStyle: { padding: 8, borderWidth: 1, borderColor: appcolor.primary, backgroundColor: appcolor.transparent, borderRadius: 8 },
        titleButton: { color: appcolor.primary, fontSize: 13, fontWeight: fontWeightBold, textAlign: 'center', padding: 1 },
        buttonContainer: { flexGrow: 1, marginHorizontal: 8 },
        mainContainer: { flex: 1, backgroundColor: appcolor.primary, padding: 16 },
        headerTitle: { width: '100%', fontSize: 23, fontWeight: '800', color: appcolor.primary, textAlign: 'center', padding: 8 },
        iconContainer: { borderRadius: 24, width: 86, height: 86, overflow: 'hidden', padding: 8, backgroundColor: appcolor.white },
        iconLottieStyle: { width: "100%", height: 150, marginBottom: 16, marginTop: 16 },
    })
    return (
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.actionContainer}>
                    ...
                    />
                    <TouchableOpacity
                        style={[styles.buttonStyle, { backgroundColor: appcolor.primary, flexGrow: 1, marginEnd: 8 }]}
                        onPress={handlerLogin}>
                        {!isLoading ?
                            <Text style={{ ...styles.titleButton, color: appcolor.light }}>Đăng nhập</Text>
                            :
