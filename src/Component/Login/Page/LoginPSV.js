...
const LoginPSV = ({ onLogin, isLoading, onFogetPassword, onShowPrivacy }) => {
    ...
    const styles = StyleSheet.create({
        ...
        logoContainer: { width: '100%', height: '20%', marginTop: 12 },
        formContainer: { paddingHorizontal: 16 },
        inputStyle: { fontSize: 13, color: appcolor.dark, paddingHorizontal: 8 },
        titleLogin: { fontWeight: fontWeightBold, fontSize: 24, color: appcolor.dark, padding: 16, paddingTop: 0, paddingBottom: 8 },
