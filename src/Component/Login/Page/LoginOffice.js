...
const LoginOffice = ({ onLogin, isLoading, onFogetPassword, onShowPrivacy }) => {
    ...
    const styles = StyleSheet.create({
        ...
        contentContainer: { flex: 1, justifyContent: 'space-between', paddingHorizontal: 16, paddingTop: 10, paddingBottom: 10 },
        ...
        actionContainer: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 },
        buttonStyle: {
            padding: 8,
            borderWidth: 1,
        ...
        titleButton: { color: appcolor.light, fontSize: 13, fontWeight: fontWeightBold, textAlign: 'center', padding: 1 },
        ...
        primaryActionButton: { backgroundColor: 'rgba(255, 255, 255, 0.94)', flex: 1 },
        footerContainer: { paddingBottom: 2 }
    })
    return (
        <View style={styles.mainContainer}>
            <ImageBackground blurRadius={6} source={officeBackground}
                            ...
                            <View style={styles.glassCard}>
                                ...
                                <View style={styles.actionContainer}>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        {!isLoading ?
                                            <Text style={{ ...styles.titleButton, color: appcolor.dark }}>Đăng nhập</Text>
                                            :
