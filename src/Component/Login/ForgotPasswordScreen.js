...
const ForgotPasswordScreen = ({ navigation, route }) => {
    ...
    const validData = async () => {
        ...
        if (isConnected) {
            ...
            if (email === null || email.length == 0) {
                ...
                if (!email.includes("@")) {
                    toastError("Email", 'Email không đúng định dạng, Vui lòng kiểm tra lại!');
                    return false
                }
            }
        } else {
    ...
    const styles = StyleSheet.create({
        ...
        companyContainer: { justifyContent: 'center', bottom: 0, width: '100%', position: 'absolute' },
        titleCompany: { textAlign: 'center', fontSize: 15, color: appcolor.placeholderText, fontWeight: 'bold' },
        addressCompany: { fontSize: 11, textAlign: 'center', color: appcolor.placeholderText, fontWeight: '500' },
        ...
        <SafeAreaView style={styles.mainContainer}>
            <View style={styles.contentMain}>
                <View style={styles.contentMain}>
                    ...
                    <Text style={styles.titleLogin}>{`Gửi yêu cầu lấy lại mật khẩu`}</Text>
                    {/* // Form */}
                    <View style={styles.formContainer}>
                        ...
                        <Input
                            ...
                            leftIcon={<Icon type='ionicon' name='mail-outline' color={appcolor.primary} />}
                        />
                    </View>
                    ...
                    <View style={styles.companyContainer}>
                        ...
                        <Text style={styles.addressCompany}>27B Nguyễn Đình Chiểu, Phường Sài Gòn, Thành Phố Hồ Chí Minh</Text>
                    </View>
                </View>
            </View>
        </SafeAreaView>
