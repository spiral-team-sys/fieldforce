                    ...
                    this.state.requestPass ?
                        ...
                        <View style={{ justifyContent: 'space-between', alignItems: 'stretch', flex: 1, backgroundColor: appcolor.primary }}>
                            <View style={{ height: '100%', width: '100%' }}>
                                ...
                                <View style={{ height: '53%', width: '100%', paddingLeft: 22, paddingRight: 22, borderTopRightRadius: 40, borderTopLeftRadius: 40, backgroundColor: appcolor.light }}>
                                    <View style={{ width: '100%', backgroundColor: appcolor.surface, borderRadius: 20, marginTop: 55 }}>
                                        <TextInput
                                    ...
                                    <View style={{ width: '100%', backgroundColor: appcolor.surface, borderRadius: 20, flexDirection: 'row' }}>
                                        <TextInput
                                    ...
                                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 15, alignSelf: 'center', justifyContent: 'center' }}>
