...
export const LGPLanbyWeekly = async data => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/lgplanbyplan',
      requestInfo,
    );
    if (response.status === 200) {
      return await response.json();
...
export const GetDailySummary = async () => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/dailysummary',
      requestInfo,
    );
    if (response.status === 200) {
...
export const LGSummaryTop = async actionResult => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/lgsummarytop',
      requestInfo,
    );
    if (response.status === 200) {
      const result = await response.json();
...
export const GetDataDashboardDetail = async (
  month,
  year,
  shopId = 0,
  actionResult,
  ...
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/detail/bymonth',
      requestInfo,
    );
    const result = await response.json();
...
export const GetDataProgressReport = async (month, year, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/progressreport',
      requestInfo,
    );
    const result = await response.json();
...
export const GetDataProgressAttendant = async (month, year, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/progressattendant',
      requestInfo,
    );
    const result = await response.json();
...
export const DataDetailSummarySSub = async (jsonData, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/summaryssub',
      requestInfo,
    );
    const result = await response.json();
...
export const DataDashboardByType = async (jsonData, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/dashboardbytype',
      requestInfo,
    );
    const result = await response.json();
    await actionResult(result);
