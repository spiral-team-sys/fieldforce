...
export const URL_DOWNLOAD_HISTORY_DISPLAYCOMPETITOR =
  URLDEFAULT + 'display/historycompetitor';
export const URL_DOWNLOAD_HISTORY_MARKET =
  URLDEFAULT + 'sellouts/GetMarketHistory';
...
export const URL_UPLOAD_AUDIT_DISPLAY =
  URLDEFAULT + 'sellouts/uploadAuditDisplay';
...
export const URL_SELLOUT_DUPLICATE_CONFIRM =
  URLDEFAULT + 'sellouts/duplicateRemove';
export const URL_SELLOUT_UPDATE_PHONE =
  URLDEFAULT + 'sellouts/updatePhoneNumber';
...
export const URL_UPLOAD_DISPLAY_COMPETITOR =
  URLDEFAULT + 'display/uploadcompetitor';
...
export const URL_UPLOAD_WORKING_SCHEDULE =
  URLDEFAULT + 'workingschedule/uploadWorkingSchedule';
...
export const URL_UPLOAD_STATUS_KTV =
  URLDEFAULT + 'lgdownload/UPLOAD_STATUS_KTV';
export const URL_CHECKMOBILE_CUSTOMER =
  URLDEFAULT + 'lgdownload/CHECK_MOBILE_CUSTOMER';
...
export const URL_WORKINGPLAN_CHANGESHIFT =
  URLDEFAULT + 'workingplan/changeshift';
export const URL_WORKINGPLAN_WORKINGLATE =
  URLDEFAULT + 'workingplan/workinglate';
export const URL_WORKINGPLAN_UPLOAD_IMAGE =
  URLDEFAULT + 'workingplan/uploadfile';
...
export const URL_GET_ATTENDANT_RESULT =
  URLDEFAULT + 'attendants/getAttendantResult';
export const URL_UPLOAD_ATTENDANT_RESULT =
  URLDEFAULT + 'attendants/uploadAttendantResult';
export const TRAINING_RESULT =
  'http://trainingsystem.spiral.com.vn/ffspanasonic/report/';
export const DATETIME_START = 'DATETIME_START';
export const DATETIME_END = 'DATETIME_END';
export const URL_GET_SELLOUT_CHART_HMD =
  URLDEFAULT + 'sellouts/GetChartSelloutHMD';
export const URL_POST_TRACKING_DISPLAY =
  URLDEFAULT + 'sellouts/uploadTrackingDisplay';
