...
const getDataEmployeeInfo = async (actionResult) => {
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/info/data`, requestInfo)
...
const getDataContactInfo = async (actionResult) => {
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/info/contact`, requestInfo)
        const result = await response.json()
        if (result.statusId == 200) {
...
const validDataEmployeeInfo = async (actionResult) => {
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/info/valid`, requestInfo)
        const result = await response.json()
        if (result.statusId == 200) {
            const _employeeInfo = result.data?.table[0] || {}
...
const saveDataEmployeeInfo = async (employeeInfo, actionResult) => {
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/info/save`, requestInfo)
        const result = await response.json()
...
const changePassword = async (itemChange, actionResult) => {
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/changepass`, requestInfo)
        const result = await response.json()
...
const UserAccess = async (deviceId, actionResult) => {
    ...
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/deviceaccess`, requestInfo)
        const result = await response.json()
...
const CheckInYEP = async (typeAction, itemUpload, actionResult) => {
    try {
        ...
        const response = await fetch(`${URLDEFAULT}employee/checkin/yep`, requestInfo)
        const result = await response.json()
        //
        if (result.statusId == 200) {
...
export const EmployeeAPI = { RegistryDevice, UserAccess, getDataEmployeeInfo, getDataContactInfo, saveDataEmployeeInfo, validDataEmployeeInfo, changePassword, CheckInYEP, GetEmployeeManager }