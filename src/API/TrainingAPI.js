...
const GetConfig = async (token, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLTRAINING + '/TnForTrainee/GetConfig',
      requestInfo,
    );
    const result = await response.json();
    actionResult && actionResult(result);
...
const SearchLesson = async (data, token, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLTRAINING + '/TnForTrainee/SearchLesson',
      requestInfo,
    );
    const result = await response.json();
    actionResult && actionResult(result);
...
const PrepareBeforeExam = async (data, token, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLTRAINING + '/TnForTrainee/PrepareBeforeExam',
      requestInfo,
    );
    const result = await response.json();
    actionResult && actionResult(result);
    ...
    return {
      statusId: 404,
      messager: 'Lỗi truy cập API PrepareBeforeExam',
      data: [],
    };
  }
};
...
const GetDataExam = async (data, token, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLTRAINING + '/TnForTrainee/GetDataExam',
      requestInfo,
    );
    const result = await response.json();
    actionResult && actionResult(result);
    ...
    return {
      statusId: 404,
      messager: 'Lỗi truy cập API GetDataExam',
      data: [],
    };
  }
};
...
const SaveAnswer = async (data, token, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLTRAINING + '/TnForTrainee/SaveExamLog',
      requestInfo,
    );
    const result = await response.json();
    actionResult && actionResult(result);
...
const SubmitExam = async (data, token, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLTRAINING + '/TnForTrainee/SaveExam',
      requestInfo,
    );
    const result = await response.json();
    actionResult && actionResult(result);
