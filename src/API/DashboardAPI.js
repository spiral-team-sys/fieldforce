...
const GetSummaryDataByShop = async (shopId, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/summary/byshop',
      requestInfo,
    );
    const result = await response.json();
    actionResult(result.data || [], null);
...
const GetDashboardDetails = async (itemFilter, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/detailbytype',
      requestInfo,
    );
    const result = await response.json();
    actionResult(result.data || [], null);
...
const MaketOverView = async (month, year) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/maketoverview',
      requestInfo,
    );
    const result = await response.json();
    return result;
...
const RoutingMonthLy = async (month, year) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/routingmonth',
      requestInfo,
    );
    const result = await response.json();
    return result;
...
const GetShareReport = async (shopId, reportDate) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/shareinfo',
      requestInfo,
    );
    const result = await response.json();
    return result;
...
const GetSummaryDisplayStatus = async actionResult => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/displaystatus',
      requestInfo,
    );
    const result = await response.json();
    actionResult(result.data || [], null);
...
const GetDataRequiredReport = async (shopId, reportId, actionResult) => {
  try {
    ...
    const response = await fetch(
      URLDEFAULT + 'dashboard/requiredreport',
      requestInfo,
    );
    const result = await response.json();
    actionResult(result.data || [], null);
...
const GetListFilter = async (reportId, actionResult) => {
  try {
    ...
    const response = await fetch(
      `${URLDEFAULT}dashboard/filterdata`,
      requestInfo,
    );
    const result = await response.json();
...
const GetMasterFilter = async (shopId, typeDashboard, actionResult) => {
  try {
    ...
    const response = await fetch(
      `${URLDEFAULT}dashboard/masterfilter`,
      requestInfo,
    );
    const result = await response.json();
...
const GetDashboardDisplayShare = async (shopId, filter = {}, actionResult) => {
  try {
    ...
    const response = await fetch(
      `${URLDEFAULT}dashboard/displayShare`,
      requestInfo,
    );
    const result = await response.json();
    actionResult(result.data || []);
...
const GetDashboardStoreSummary = async (shopId, actionResult) => {
  try {
    ...
    const response = await fetch(
      `${URLDEFAULT}dashboard/storesummary`,
      requestInfo,
    );
    const result = await response.json();
    actionResult(result.data || {});
...
export const DashboardAPI = {
  GetMasterFilter,
  GetDashboardDisplayShare,
  LogUserAccess,
  MaketOverView,
  RoutingMonthLy,
  GetDashboardDetails,
  GetShareReport,
  GetSummaryDataByShop,
  GetSummaryDisplayStatus,
  GetDataRequiredReport,
  GetListFilter,
