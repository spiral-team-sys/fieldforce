...
const CameraAI = React.forwardRef((props, ref) => {
  ...
  const cameraSwitch = () => {
    ...
    _cam.type =
      _cam.type === RNCamera.Constants.Type.back
    ...
    <View style={styles.container}>
      <RNCamera
        ...
        onGoogleVisionBarcodesDetected={
          camOption.useBarcode ? handledBarCode : null
        }
      />
      {camOption.zoom !== 0 && (
        <Text
        ...
        >
          Đang phóng to {camOption.zoom < 0 ? 0 : parseInt(camOption.zoom * 10)}
          x
        </Text>
      )}
      <Text
      ...
      <View style={{ flex: 0, flexDirection: 'row', justifyContent: 'center' }}>
        <TouchableOpacity
          onPress={() => SheetManager.show('settings')}
          style={{
        ...
        >
          <SpiralIcon size={33} color={appcolor.primary} name="settings" />
        </TouchableOpacity>
        <TouchableOpacity
          onPress={takePicture}
          style={{
        ...
        >
          <SpiralIcon size={46} color={appcolor.primary} name="camera" />
        </TouchableOpacity>
        <TouchableOpacity
      ...
      >
        <View style={{ margin: 7 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity
              onPress={() => onFlashMode(RNCamera.Constants.FlashMode.auto)}
              style={{
                alignItems: 'center',
                padding: 7,
                marginHorizontal: 7,
            ...
            >
              <SpiralIcon
                name="flash-auto"
                color={
                  camOption.flashMode === RNCamera.Constants.FlashMode.auto
                    ? appcolor.primary
                    : appcolor.dark
                }
              />
            ...
            <TouchableOpacity
              onPress={() => onFlashMode(RNCamera.Constants.FlashMode.off)}
              style={{
                alignItems: 'center',
                padding: 7,
                marginHorizontal: 7,
            ...
            >
              <SpiralIcon
                name="flash-off"
                color={
                  camOption.flashMode === RNCamera.Constants.FlashMode.off
                    ? appcolor.primary
                    : appcolor.dark
                }
              />
            ...
            <TouchableOpacity
              onPress={() => onFlashMode(RNCamera.Constants.FlashMode.on)}
              style={{
                alignItems: 'center',
                padding: 7,
                marginHorizontal: 7,
            ...
            >
              <SpiralIcon
                name="flash-on"
                color={
                  camOption.flashMode === RNCamera.Constants.FlashMode.on
                    ? appcolor.primary
                    : appcolor.dark
                }
              />
          ...
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity
              ...
              onPress={() => setCamOption({ ...camOption, zoom: 0.0 })}
            >
              <SpiralIcon
                name="autorenew"
                color={camOption.zoom !== 0 ? appcolor.primary : appcolor.dark}
              />
              <Text style={{ color: appcolor.dark }}>Mặc định</Text>
            </TouchableOpacity>
            <TouchableOpacity
              disabled={camOption.zoom === 1.0 ? true : false}
              style={{
                alignItems: 'center',
                padding: 7,
                marginHorizontal: 7,
              ...
              onPress={() => onZoom(0.1)}
            >
              <SpiralIcon name="zoom-in" />
              <Text style={{ color: appcolor.dark }}>Phóng to</Text>
            </TouchableOpacity>
            <TouchableOpacity
              disabled={camOption.zoom === 0.0 ? true : false}
              style={{
                alignItems: 'center',
                padding: 7,
                marginHorizontal: 7,
