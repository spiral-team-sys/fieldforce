...
export const GroupCheckBox = ({ item, keyValue, onChange }) => {
    ...
    const styles = StyleSheet.create({
        ...
        viewAction: {},
        checkbox: { width: '100%', backgroundColor: appcolor.transparent, padding: 4, margin: 0, borderColor: appcolor.transparent, textAlign: 'center' },
        titleCheckBox: { padding: 0, margin: 0, fontSize: 13, color: appcolor.blacklight, fontWeight: '500' }
    })
        ...
        <View style={styles.mainContainer}>
            <View style={styles.viewAction}>
                <CheckBox
                    ...
                    textStyle={{ ...styles.titleCheckBox, color: item[keyValue] == 1 ? appcolor.primary : appcolor.blacklight }}
                />
                <CheckBox
