...
const MultiplePermissions = ({ navigation }) => {
  ...
  const LoadData = async () => {
    ...
    await setDataPermission(
      Platform.OS == 'ios' ? PermissionsList.ios : PermissionsList.android,
    );
    await setMutate(e => !e);
  };
  ...
  const RenderItemPermission = () => {
    ...
    dataPermission.map((item, index) => {
              ...
              <View key={index} style={styles.itemView}>
                <View style={styles.itemContainer}>
                  ...
                  <Text style={styles.contentView}>
                    Vui lòng cho phép quyền truy cập máy ảnh để sử dụng chức
                    năng chấm công và chụp hình báo cáo
                  </Text>
                  {item.isResult !== RESULTS.GRANTED ? (
                    <Button
                      ...
                      title="Cho phép"
                      onPress={() => handlerSettingPermission(item.name)}
                    />
                  ) : (
                    <Button
                      disabled={true}
            ...
            uiView.push(
              <View key={index} style={styles.itemView}>
                <View style={styles.itemContainer}>
                  ...
                  <Text style={styles.contentView}>
                    Vui lòng cho phép quyền truy cập vị trí để sử dụng chức năng
                    chấm công
                  </Text>
                  {item.isResult !== RESULTS.GRANTED ? (
                    <Button
            ...
            uiView.push(
              <View key={index} style={styles.itemView}>
                <View style={styles.itemContainer}>
                  ...
                  <Text style={styles.contentView}>
                    Vui lòng cho phép quyền truy cập bộ nhớ
                  </Text>
                  {item.isResult !== RESULTS.GRANTED ? (
                    <Button
                      type="outline"
            ...
            uiView.push(
              <View key={index} style={styles.itemView}>
                <View style={styles.itemContainer}>
                  ...
                  <Text style={styles.contentView}>
                    Vui lòng cho phép quyền truy cập danh bạ để sử dụng số điện
                    thoại liên hệ
                  </Text>
                  {item.isResult !== RESULTS.GRANTED ? (
                    <Button
      ...
      } else console.log(item.isResult, 'RenderItemPermission');
    });
    if (uiView.length === 0) return <LoginWhirlPool />;
    else return uiView;
  };
  return (
