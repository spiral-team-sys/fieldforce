...
export const VerifyLocation = ({ navigation, startAction, labelAction }) => {
        ...
        <View style={{ flex: 1, }} >
            ...
            <TouchableOpacity
                ...
                style={{
                    ...
                    zIndex: 5, bottom: 40, right: 20, justifyContent: 'center'
                }}>
                <Icon
                    color={appcolor.info}
                    name='location-arrow'
            ...
            <Button title={labelAction + "tại vị trí này"}
