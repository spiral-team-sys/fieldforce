...
const PreviewAction = ({ isLoading = false, photoUri = null, onSuccess, onReject }) => {
    ...
    const styles = StyleSheet.create({
        previewContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: appcolor.black },
        ...
        titlePreviewAction: { fontSize: 16, fontWeight: fontWeightBold, color: appcolor.white },
        loadingView: { position: 'absolute', zIndex: 1 }
    })

    return (
        <View style={styles.previewContainer}>
            <LoadingDefault isLoading={isLoading} title='Đang lưu dữ liệu' color={appcolor.primary} styles={styles.loadingView} />
            <Image
