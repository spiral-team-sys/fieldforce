...
const OVAL_CY = deviceHeight * 0.40;
...
const FaceScanFrame = ({ verifyStatus = 'idle', livenessVerified = false, faceCount = 0 }) => {
    ...
    const strokeWidth = verifyStatus === 'verified' || verifyStatus === 'failed' ? 3 : 2.5;
            ...
            <Svg width={deviceWidth} height={deviceHeight}>
                <Defs>
                    <Mask id="faceCutout" x="0" y="0" width="100%" height="100%">
                        <Rect x="0" y="0" width={deviceWidth} height={deviceHeight} fill="white" />
                        <Ellipse cx={OVAL_CX} cy={OVAL_CY} rx={OVAL_RX} ry={OVAL_RY} fill="black" />
                    </Mask>
                </Defs>
