...
export const SearchData = ({ placeholder, value = null, iconName = 'search', onSearchData, containerStyle }) => {
    ...
    const styles = StyleSheet.create({
        searchContainer: { padding: Platform.OS == 'android' ? 0 : 3, paddingHorizontal: 8, borderRadius: 20, backgroundColor: appcolor.light, borderWidth: 0.5, borderColor: appcolor.primary, margin: 8, containerStyle },
        searchContainerInput: { padding: Platform.OS == 'android' ? 0 : 3, paddingHorizontal: 8, borderRadius: 20, backgroundColor: appcolor.primary, borderWidth: 0.5, margin: 8 },
    ...
    return (
        <FormGroup
            ...
            containerStyle={[search.isSearch ? styles.searchContainerInput : styles.searchContainer, containerStyle]}
