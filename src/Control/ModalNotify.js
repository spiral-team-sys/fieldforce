      ...
      >
        ...
        >
          ...
          {isMessageView ? (
            ...
            <Text style={{ color: appcolor.dark }}>{messager}</Text>
          )}
          {disableOK && isUseHintArrow && <ScrollHintArrow />}
          {isUseButton && (
            <View
              style={{
                justifyContent: 'center',
            ...
            >
              <TouchableOpacity
                ...
                style={{
                  justifyContent: 'center',
                  alignItems: 'center',
                  width: isChoose ? deviceWidth * 0.3 : deviceWidth * 0.6,
                  borderRadius: 20,
              ...
              >
                <Text
                  style={{ color: appcolor.dark, opacity: disableOK ? 0.2 : 1 }}
                >
                  {isChoose ? 'Từ chối' : titleConfirm}
                </Text>
              </TouchableOpacity>
              {isChoose && (
                <TouchableOpacity
